...
(Yield_plot_22_23_X3_talk <- summer_22_23 %>% 
   ggplot() +
   geom_line(aes(Date, X4.chosen_yield, color = "Bryum argemteum"), alpha = 0.5)+
   geom_line(aes(Date, X3.chosen_yield, color = "Austroplaca soropelta"), alpha = 0.5)+  # Add a line that joins the points
  scale_color_manual(values = c("Bryum argemteum" = "#119683", "Austroplaca soropelta" = "#ff914d")) +
