...
data_reactivation_summary <- data_reactivation %>% 
  mutate(year = as.factor(year),
         ...
         species = if_else(sample == "X3", "Austroplaca soropelta", "Bryum argemteum")) %>% 
...
ggsave(filename = "graphs_correlation/graph_decline.png", graph_decline, width = 35, height = 20, units = "cm", device = "png")  # Save graph
