...
(total_active_hours <- total_activetime_stats_X3 %>% # filter from the dataset the total number of active hours
  filter(Condition == TRUE) %>%
  select(Total_time))

(Percentage_active_days <- total_active_hours/(nrow(data_clean) + nrow(data_clean_23)) * 100) # calculate the percentage 
...
(total_active_hours_19_20 <- summer_activetime_stats_X3 %>%  # filter from the dataset the total number of active hours
  filter(Condition == TRUE) %>%
  select(Count_19_20))

(total_active_hours_20_21 <- summer_activetime_stats_X3 %>%
  filter(Condition == TRUE) %>%
  select(Count_20_21))

(total_active_hours_21_22 <- summer_activetime_stats_X3 %>%
  filter(Condition == TRUE) %>%
  select(Count_21_22))

(total_active_hours_22_23 <- summer_activetime_stats_X3 %>%
  filter(Condition == TRUE) %>%
  select(Count_22_23))

(Percentage_active_hours_19_20 <- total_active_hours_19_20 /nrow(summer_19_20) * 100) # put active hours as a percentage

(Percentage_active_hours_20_21 <- total_active_hours_20_21 /nrow(summer_20_21) * 100)

(Percentage_active_hours_21_22 <- total_active_hours_21_22 /nrow(summer_21_22) * 100)

(Percentage_active_hours_22_23 <- total_active_hours_22_23 /nrow(summer_22_23) * 100)
...
(total_active_hours_19_20_nov <- month_activetime_stats_X3 %>%  # filter from the dataset the total number of active hours
  filter(Condition == TRUE) %>%
  select(Count_19_20_nov))

(total_active_hours_19_20_dec <- month_activetime_stats_X3 %>%  # filter from the dataset the total number of active hours
  filter(Condition == TRUE) %>%
  select(Count_19_20_dec))

(total_active_hours_19_20_jan <- month_activetime_stats_X3 %>%  # filter from the dataset the total number of active hours
  filter(Condition == TRUE) %>%
  select(Count_19_20_jan))

(total_active_hours_19_20_feb <- month_activetime_stats_X3 %>%  # filter from the dataset the total number of active hours
  filter(Condition == TRUE) %>%
  select(Count_19_20_feb))

(total_active_hours_20_21_nov <- month_activetime_stats_X3 %>%  # filter from the dataset the total number of active hours
  filter(Condition == TRUE) %>%
  select(Count_20_21_nov))

(total_active_hours_20_21_dec <- month_activetime_stats_X3 %>%  # filter from the dataset the total number of active hours
  filter(Condition == TRUE) %>%
  select(Count_20_21_dec))

(total_active_hours_20_21_jan <- month_activetime_stats_X3 %>%  # filter from the dataset the total number of active hours
  filter(Condition == TRUE) %>%
  select(Count_20_21_jan))

(total_active_hours_20_21_feb <- month_activetime_stats_X3 %>%  # filter from the dataset the total number of active hours
  filter(Condition == TRUE) %>%
  select(Count_20_21_feb))

(total_active_hours_21_22_nov <- month_activetime_stats_X3 %>%  # filter from the dataset the total number of active hours
  filter(Condition == TRUE) %>%
  select(Count_21_22_nov))

(total_active_hours_21_22_dec <- month_activetime_stats_X3 %>%  # filter from the dataset the total number of active hours
  filter(Condition == TRUE) %>%
  select(Count_21_22_dec))

(total_active_hours_21_22_jan <- month_activetime_stats_X3 %>%  # filter from the dataset the total number of active hours
  filter(Condition == TRUE) %>%
  select(Count_21_22_jan))

(total_active_hours_21_22_feb <- month_activetime_stats_X3 %>%  # filter from the dataset the total number of active hours
  filter(Condition == TRUE) %>%
  select(Count_21_22_feb))

(total_active_hours_22_23_nov <- month_activetime_stats_X3 %>%  # filter from the dataset the total number of active hours
  filter(Condition == TRUE) %>%
  select(Count_22_23_nov))

(total_active_hours_22_23_dec <- month_activetime_stats_X3 %>%  # filter from the dataset the total number of active hours
  filter(Condition == TRUE) %>%
  select(Count_22_23_nov))

(total_active_hours_22_23_jan <- month_activetime_stats_X3 %>%  # filter from the dataset the total number of active hours
  filter(Condition == TRUE) %>%
  select(Count_22_23_jan))

(total_active_hours_22_23_feb <- month_activetime_stats_X3 %>%  # filter from the dataset the total number of active hours
  filter(Condition == TRUE) %>%
  select(Count_22_23_feb))

(Percentage_active_hours_19_20_nov <- total_active_hours_19_20_nov /nrow(summer_19_20 %>% filter(Month == 11)) * 100) # put active hours as a percentage

(Percentage_active_hours_19_20_dec <- total_active_hours_19_20_dec /nrow(summer_19_20 %>% filter(Month == 12)) * 100) # put active hours as a percentage

(Percentage_active_hours_19_20_jan <- total_active_hours_19_20_nov /nrow(summer_19_20 %>% filter(Month == 1)) * 100) # put active hours as a percentage

(Percentage_active_hours_19_20_feb <- total_active_hours_19_20_nov /nrow(summer_19_20 %>% filter(Month == 2)) * 100) # put active hours as a percentage

(Percentage_active_hours_20_21_nov <- total_active_hours_20_21_nov /nrow(summer_20_21 %>% filter(Month == 11)) * 100)

(Percentage_active_hours_20_21_dec <- total_active_hours_20_21_dec /nrow(summer_20_21 %>% filter(Month == 12)) * 100)

(Percentage_active_hours_20_21_jan <- total_active_hours_20_21_jan /nrow(summer_20_21 %>% filter(Month == 1)) * 100)

(Percentage_active_hours_20_21_feb <- total_active_hours_20_21_feb /nrow(summer_20_21 %>% filter(Month == 2)) * 100)

(Percentage_active_hours_21_22_nov <- total_active_hours_21_22_nov /nrow(summer_21_22 %>% filter(Month == 11)) * 100)

(Percentage_active_hours_21_22_dec <- total_active_hours_21_22_dec /nrow(summer_21_22 %>% filter(Month == 12)) * 100)

(Percentage_active_hours_21_22_jan <- total_active_hours_21_22_jan /nrow(summer_21_22 %>% filter(Month == 1)) * 100)

(Percentage_active_hours_21_22_feb <- total_active_hours_21_22_feb /nrow(summer_21_22 %>% filter(Month == 2)) * 100)

(Percentage_active_hours_22_23_nov <- total_active_hours_22_23_nov /nrow(summer_22_23 %>% filter(Month == 11)) * 100)

(Percentage_active_hours_22_23_dec <- total_active_hours_22_23_dec /nrow(summer_22_23 %>% filter(Month == 12)) * 100)

(Percentage_active_hours_22_23_jan <- total_active_hours_22_23_jan /nrow(summer_22_23 %>% filter(Month == 1)) * 100)

(Percentage_active_hours_22_23_feb <- total_active_hours_22_23_feb /nrow(summer_22_23 %>% filter(Month == 2)) * 100)
```
...
mean_Temp_active_X3 <- data_clean %>% 
  group_by(X3.Active) %>% 
  summarise(mean_temp = mean(X3.Temp))
  
mean_Temp_active2_X3 <- data_clean_23 %>% 
   group_by(X3.Active) %>% 
  summarise(mean_temp = mean(X3.Temp))
...
## 9. Make plots for PAR and Temperature in each summer, in each sample (check activity under snowcover). Same axis (use for comparison)
## 10. Plot data for all the measuring period

### Graph for PAR year round (This need to be changed to include 2022-2023)

```{r}
(PAR_year_round_19_22 <- data_clean %>%
  mutate(mean_PAR = rowMeans(select(., c("X1.PAR", "X2.PAR", "X3.PAR", "X4.PAR")), na.rm = TRUE)) %>%  # calcualte mean PAR across all samples
...
(yield_year_round_19_22 <- data_clean %>%
  ggplot() +
...
## 10. Plot data for the heatwave March 2022
