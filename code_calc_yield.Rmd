...
(graph_temp_y_19_22_moss <- data_clean %>% 
  ...
  ggplot(aes(av_moss_temp, av_moss_yield, color = "Bryum argemteum")) +
  geom_point() +
  theme_graphs_env_cond()+
  labs(x = "\nTemperature ºC", y = "Yield Average moss ") +
   scale_color_manual(values = c( "Bryum argemteum" = "#119683")) +
  theme(axis.text.x = element_text(angle = 0),
        legend.position = "none"))
...
(graph_rh_y_all_period_moss <- data_yield_rh %>%  #
  ggplot() + 
  geom_point(aes( Rhmean, X1.Y, color = "Bryum argemteum", fill = "Austroplaca soropelta", alpha = 0.1)) +
    # geom_polygon(aes(Rhmean, X3.chosen_yield, alpha = 0.1)) +
  theme_graphs_env_cond()+
  labs(x = "\nRH %", y = "Yield moss ") +
    ylim(c(0.01, 0.8))+
...
(PAR_plot_19_20_undersnow_2_dec <- summer_19_20 %>%
  ...
  geom_line(aes(Date, X3.PAR, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.PAR, color = "Bryum argemteum X1")) + # add a line that joins the points
  geom_line(aes(Date, X2.PAR, color = "Bryum argemteum X2"), alpha = 0.5) + # add a line that joins the points
  geom_line(aes(Date, X4.PAR, color = "Bryum argemteum X4"), alpha = 0.5) + # add a line that joins the points
...
(Yield_plot_19_20_undersnow_2_dec <- summer_19_20 %>% 
  ...
  geom_line(aes(Date, X1.Y, color = "Bryum argemteum X1")) + # add a line that joins the points
  geom_line(aes(Date, X2.Y, color = "Bryum argemteum X2", alpha = 0.5)) + # add a line that joins the points
  geom_line(aes(Date, X4.Y, color = "Bryum argemteum X4", alpha = 0.5)) +
  scale_color_manual(values = c(
    "Austroplaca soropelta" = "#ff914d",
    "Bryum argemteum X1" = "#119683",
    "Bryum argemteum X2" = "#74c476",
...
(ETR_plot_19_20_undersnow_2_dec <- summer_19_20 %>% 
  ...
  geom_line(aes(Date, X3.ETR, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.ETR, color = "Bryum argemteum X1")) + # add a line that joins the points
  geom_line(aes(Date, X2.ETR, color = "Bryum argemteum X2", alpha = 0.5)) + # add a line that joins the points
  geom_line(aes(Date, X4.ETR, color = "Bryum argemteum X4", alpha = 0.5)) +
  scale_color_manual(values = c(
    "Austroplaca soropelta" = "#ff914d",
    "Bryum argemteum X1" = "#119683",
    "Bryum argemteum X2" = "#74c476",
...
(Yield_plot_21_22_undersnow_11_dec <- summer_21_22 %>% 
  ...
  geom_line(aes(Date, X1.Y, color = "Bryum argemteum X1")) + # add a line that joins the points
  geom_line(aes(Date, X2.Y, color = "Bryum argemteum X2", alpha = 0.5)) + # add a line that joins the points
  geom_line(aes(Date, X4.chosen_yield, color = "Bryum argemteum X4", alpha = 0.5)) +
  scale_color_manual(values = c(
    "Austroplaca soropelta" = "#ff914d",
    "Bryum argemteum X1" = "#119683",
    "Bryum argemteum X2" = "#74c476",
...
(ETR_plot_21_22_undersnow_11_dec <- summer_21_22 %>% 
  ...
  geom_line(aes(Date, X1.ETR, color = "Bryum argemteum X1")) + # add a line that joins the points
  geom_line(aes(Date, X2.ETR, color = "Bryum argemteum X2", alpha = 0.5)) + # add a line that joins the points
  geom_line(aes(Date, X4.chosen_ETR, color = "Bryum argemteum X4", alpha = 0.5)) +
  scale_color_manual(values = c(
    "Austroplaca soropelta" = "#ff914d",
    "Bryum argemteum X1" = "#119683",
    "Bryum argemteum X2" = "#74c476",
...
(temp_plot_22_23_undersnow_5_dec <- summer_22_23 %>% 
   ...
   geom_line(aes(DateTime, X3.Temp, color = "Austroplaca soropelta"))+  # add a line that joins the points
    geom_line(aes(DateTime, X1.Temp, color = "Bryum argemteum X1"))+  # add a line that joins the points
    geom_line(aes(DateTime, X2.Temp, color = "Bryum argemteum X2"))+  # add a line that joins the points
    geom_line(aes(DateTime, X4.Temp, color = "Bryum argemteum X4"))+  # add a line that joins the points
   geom_hline(yintercept = 0, color = "blue", linetype = "dashed") +
   scale_color_manual(values = c( "Austroplaca soropelta" = "#ff914d", 
                                  "Bryum argemteum X1" = "#119683", 
                                  "Bryum argemteum X2" = "#74c476", 
...
(PAR_plot_22_23_undersnow_5_dec <- summer_22_23 %>%
  ...
  geom_line(aes(DateTime, X1.PAR, color = "Bryum argemteum X1")) + # add a line that joins the points
  geom_line(aes(DateTime, X2.PAR, color = "Bryum argemteum X2"), alpha = 0.5) + # add a line that joins the points
  geom_line(aes(DateTime, X4.PAR, color = "Bryum argemteum X4"), alpha = 0.5) + # add a line that joins the points
  scale_color_manual(values = c(
    "Austroplaca soropelta" = "#ff914d",
    "Bryum argemteum X1" = "#119683",
    "Bryum argemteum X2" = "#74c476",
...
(Yield_plot_22_23_undersnow_5_dec <- summer_22_23 %>% 
  ...
  geom_line(aes(DateTime, X1.Y, color = "Bryum argemteum X1")) + # add a line that joins the points
  geom_line(aes(DateTime, X2.Y, color = "Bryum argemteum X2", alpha = 0.5)) + # add a line that joins the points
  geom_line(aes(DateTime, X4.chosen_yield, color = "Bryum argemteum X4", alpha = 0.5)) +
  scale_color_manual(values = c(
    "Austroplaca soropelta" = "#ff914d",
    "Bryum argemteum X1" = "#119683",
    "Bryum argemteum X2" = "#74c476",
...
(ETR_plot_22_23_undersnow_5_dec <- summer_22_23 %>% 
  ...
  geom_line(aes(DateTime, X1.ETR, color = "Bryum argemteum X1")) + # add a line that joins the points
  geom_line(aes(DateTime, X2.ETR, color = "Bryum argemteum X2", alpha = 0.5)) + # add a line that joins the points
  geom_line(aes(DateTime, X4.chosen_ETR, color = "Bryum argemteum X4", alpha = 0.5)) +
  scale_color_manual(values = c(
    "Austroplaca soropelta" = "#ff914d",
    "Bryum argemteum X1" = "#119683",
    "Bryum argemteum X2" = "#74c476",
...
(temp_plot_19_20_results <- summer_19_20 %>% 
  ggplot() +
  geom_line(aes(Date, X3.Temp, color = "Austroplaca soropelta")) +  # add a line that joins the points
  geom_line(aes(Date, av_moss_temp, color = "Bryum argemteum")) +  # add a line that joins the points           
  geom_hline(yintercept = 0, color = "blue", linetype = "dashed") +
...
(PAR_plot_19_20_results <- summer_19_20 %>% 
   ggplot() +
   geom_line(aes(Date, X3.PAR, color = "Austroplaca soropelta")) +  # add a line that joins the points
   geom_line(aes(Date, av_moss_PAR, color = "Bryum argemteum")) +  # add a line that joins the points
...
(Yield_plot_19_20_results<- summer_19_20 %>% 
   ggplot() +
   geom_line(aes(Date, X3.Y, color = "Austroplaca soropelta"))+  # Add a line that joins the points
   geom_line(aes(Date, av_moss_yield, color = "Bryum argemteum"))+  # Add a line that joins the points
   labs(x = "\nDate (day)", y = "Yield ") +
    scale_color_manual(values = c("Bryum argemteum" = "#119683", "Austroplaca soropelta" = "#ff914d")) +
   theme_graphs_env_cond() +
      ylim(0, 0.8) +
...
(ETR_plot_19_20_results <- summer_19_20 %>% 
   ggplot() +
   geom_line(aes(Date, X3.ETR, color = "Austroplaca soropelta"))+  # Add a line that joins the points
   geom_line(aes(Date, av_moss_ETR, color = "Bryum argemteum"))+  # Add a line that joins the points
   labs(x = "\nDate (day)", y = "ETR\n(μmol e- \nm−2s−1) ") +
    scale_color_manual(values = c("Bryum argemteum" = "#119683", "Austroplaca soropelta" = "#ff914d")) +
   theme_graphs_env_cond() +
    theme(axis.text.x = element_blank(), 
...
(temp_plot_21_22_undersnow_11_dec <- summer_21_22 %>% 
   ...
   scale_color_manual(values = c(
    "Austroplaca soropelta" = "#ff914d",
    "Bryum argemteum X1" = "green1",
    "Bryum argemteum X2" = "#35B779FF",
    "Bryum argemteum X4" = "olivedrab4")) +
   labs(x = "\nDate (day)", y = "Thallus \nTemperature \n(ºC) X3 ") +
   theme_graphs_env_cond()+
   ylim(-10, 10) +
   theme(axis.text.x = element_blank(),
