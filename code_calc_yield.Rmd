...
20th-nov-2023
Added the data for summer 22-23. Find in section 4.b
...
data_clean_23 <- data_23[, -c(1:3,6,8,9)] %>%   # create a new data set without columns 1, 2, 3, 6, 8, 9
  mutate(Day_cum = floor(`Excel date`)) %>%  # maintain cumulative date but change column name to more informative one and truncate it to remove decimals
