...
(temp_plot_19_20_results <- summer_19_20 %>% 
   ggplot() +
   geom_line(aes(Date, X3.Temp, color = "Austroplaca soropelta")) +  # add a line that joins the points
   geom_line(aes(Date, X1.Temp, color = "Bryum argemteum")) +  # add a line that joins the points           
   geom_hline(yintercept = 0, color = "blue", linetype = "dashed") +
   labs(x = "\nDate (day)", y = "Temperature \n(ºC) X3 ") +
   scale_color_manual(values = c("Bryum argemteum" = "#119683", "Austroplaca soropelta" = "#ff914d")) +
   theme_graphs_env_cond()+
...
(PAR_plot_19_20_results <- summer_19_20 %>% 
   ggplot() +
   geom_line(aes(Date, X3.PAR, color = "Austroplaca soropelta")) +  # add a line that joins the points
   geom_line(aes(Date, X1.PAR, color = "Bryum argemteum")) +  # add a line that joins the points
   labs(x = "\nDate 2019-2020 (day)", y = "PAR X3\n(µmol m-2 s^-1)") +
  scale_color_manual(values = c("Bryum argemteum" = "#119683", "Austroplaca soropelta" = "#ff914d")) +
...
(Yield_plot_19_20_results<- summer_19_20 %>% 
   ggplot() +
   geom_line(aes(Date, X3.Y, color = "Austroplaca soropelta"))+  # Add a line that joins the points
   geom_line(aes(Date, X1.Y, color = "Bryum argemteum"))+  # Add a line that joins the points
   labs(x = "\nDate (day)", y = "Yield \nLichen X3 ") +
    scale_color_manual(values = c("Bryum argemteum" = "#119683", "Austroplaca soropelta" = "#ff914d")) +
   theme_graphs_env_cond() +
    theme(axis.text.x = element_blank(),
...
(ETR_plot_19_20_results <- summer_19_20 %>% 
   ggplot() +
   geom_line(aes(Date, X3.ETR, color = "Austroplaca soropelta"))+  # Add a line that joins the points
   geom_line(aes(Date, X1.ETR, color = "Bryum argemteum"))+  # Add a line that joins the points
   labs(x = "\nDate (day)", y = "ETR\n(μmol e- m−2s−1) \nLichen X3 ") +
    scale_color_manual(values = c("Bryum argemteum" = "#119683", "Austroplaca soropelta" = "#ff914d")) +
   theme_graphs_env_cond() +
    theme(axis.text.x = element_blank(),
...
ggsave(filename = "graphs_characterise/combined_plot_19_20_results.png", combined_plot_19_20_results, width = 54,height = 18, units = "cm", device = "png")  # Save graph
