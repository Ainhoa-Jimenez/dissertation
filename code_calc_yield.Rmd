...
ggsave(filename = "graphs_under_snow/combined_plot_21_22_undersnow_11_dec.png", combined_plot_21_22_undersnow_11_dec, width = 54,height = 18, units = "cm",device = "png")  # Save graph
```
...
ggsave(filename = "graphs_under_snow/combined_plot_21_22_undersnow_31_dec.png", combined_plot_21_22_undersnow_31_dec, width = 54,height = 18, units = "cm",device = "png")  # Save graph
...
(temp_plot_21_22_undersnow_16_feb <- summer_21_22 %>% 
   filter (Day_cum > 44607 & Day_cum < 44613) %>%  # filter the 15th 21nd of feb
   ggplot() + 
   geom_line(aes(Date, X3.Temp, color = "Austroplaca soropelta"))+  # add a line that joins the points
    geom_line(aes(Date, X1.Temp, color = "Bryum argemteum X1"))+  # add a line that joins the points
    geom_line(aes(Date, X2.Temp, color = "Bryum argemteum X2"))+  # add a line that joins the points
...
ggsave(filename = "graphs_under_snow/combined_plot_21_22_undersnow_16_feb.png", combined_plot_21_22_undersnow_16_feb, width = 54,height = 18, units = "cm",device = "png")  # Save graph
