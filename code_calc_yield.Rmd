...
(Percentage_active_day_X3 <- total_active_hours_X3/(nrow(data_clean) + nrow(data_clean_23)) * 100) # calculate the percentage 
```
...
(mean_Temp_active_X3_19_20 <- summer_19_20 %>% 
  group_by(X3.Active) %>% 
  summarise( n = n(),
    mean_temp = mean(X3.Temp),
    max_temp = max(X3.Temp),
...
(mean_Temp_active_X3_20_21 <- summer_20_21 %>% 
  group_by(X3.Active) %>% 
  summarise( n = n(),
    mean_temp = mean(X3.Temp),
    max_temp = max(X3.Temp),
...
(mean_Temp_active_X3_21_22 <- summer_21_22 %>% 
  group_by(X3.Active) %>% 
  summarise( n = n(),
    mean_temp = mean(X3.Temp),
    max_temp = max(X3.Temp),
...
(mean_Temp_active_X3_22_23 <- summer_22_23 %>% 
  group_by(X3.Active) %>% 
  summarise( n = n(),
    mean_temp = mean(X3.Temp),
    max_temp = max(X3.Temp),
