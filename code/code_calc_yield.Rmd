...
4.3. Rename columns so it is easy to use
...
# Graph for the composed graph
(PAR_year_round_19_23_graph <- rbind(
  data_clean %>% 
    select(Date, X1.PAR, X2.PAR, X3.PAR, X4.PAR),
  data_clean_23 %>% 
    select(Date, X1.PAR, X2.PAR, X3.PAR, X4.PAR)) %>%
...
ggsave(filename = "graphs_env_conditions/PAR_year_round_19_23.png", PAR_year_round_19_23, width = 54,height = 18, units = "cm", device = "png")  # Save graph
...
(yield_year_round_19_22 <- rbind(data_clean)%>%
  ggplot() +
  geom_line(aes(Date, X1.Y, color = "Bryum argenteum"), alpha = 0.4) +
  geom_line(aes(Date, X2.Y, color = "Bryum argenteum"), alpha = 0.4) + 
  geom_line(aes(Date, X3.Y, color = "Austroplaca soropelta"), alpha = 0.7) +
  geom_line(aes(Date, X4.Y, color = "Bryum argenteum"), alpha = 0.4) +
  theme_graphs_env_cond() +
  scale_x_datetime(date_breaks = "1 month", date_labels = "%m %Y") +
...
(yield_year_round_22_23 <- rbind(data_clean_23)%>%
  ...
  geom_line(aes(Date, X4.chosen_yield, color = "Bryum argenteum"), alpha = 0.4) +
  theme_graphs_env_cond() +
  scale_x_datetime(date_breaks = "1 month", date_labels = "%m %Y") +
  scale_color_manual(values = c("Bryum argenteum" = "#119683", "Austroplaca soropelta" = "#ff914d")) +
  labs(color = "Species") + # This adds a legend for the colors
...
(temp_year_round_19_23 <- rbind(
  ...
  ggplot() +
  geom_line(aes(Date, X1.Temp, color = "Bryum argenteum"), alpha = 0.4) +
  geom_line(aes(Date, X2.Temp, color = "Bryum argenteum"), alpha = 0.4) + 
  geom_line(aes(Date, X3.Temp, color = "Austroplaca soropelta"), alpha = 0.7) +
  geom_line(aes(Date, X4.Temp, color = "Bryum argenteum"), alpha = 0.4) +
  scale_color_manual(values = c("Bryum argenteum" = "#119683", "Austroplaca soropelta" = "#ff914d")) +
  geom_hline(yintercept = 0, color = "blue", linetype = "dashed") +
  theme_graphs_env_cond() +
  scale_x_datetime(date_breaks = "1 month", date_labels = "%m %Y") +
...
ggsave(filename = "graphs_env_conditions/temp_year_round_19_23.png", temp_year_round_19_23, width = 54,height = 18, units = "cm", device = "png")  # Save graph


# Graph for the composed graph
(temp_year_round_19_23_graph <- rbind(
  data_clean %>% 
    select(Date, X1.Temp, X2.Temp, X3.Temp, X4.Temp),
  data_clean_23 %>% 
    select(Date, X1.Temp, X2.Temp, X3.Temp, X4.Temp)
...
# Graph for the composed graph
(air_temp_year_round_19_23_graph <- data_met %>%
  ggplot(aes(DateTime, Tmean)) +
  geom_line() +
  geom_hline(yintercept = 0, color = "blue", linetype = "dashed") +
  theme_graphs_env_cond() +
...
(Yield_plot_march_22_23_X2 <- data_clean %>% 
   ...
   mutate(Date_Combined = reorder(Date_Combined, Day_cum)) %>%  # reorder the factors of Date_Combined according to the values of Day_cum. Do it for each subset individually because factors repeat for each year
   ggplot() +
   geom_point(aes(Date_Combined, X2.Y))+  # Add points for the data
   geom_line(aes(Date_Combined, X2.Y))+  # Add a line that joins the points
   labs(x = "\nDate (day)", y = "Yield \nMoss X2 ") +
   theme_graphs_env_cond() +
    theme(axis.text.x = element_blank(),
        axis.title.x = element_blank()))  # Remove axis label and text for the graph)
...
(temp_plot_march_22_23 <- data_clean %>% 
   ...
   mutate(Date_Combined = reorder(Date_Combined, Day_cum)) %>%  # reorder the factors of Date_Combined according to the values of Day_cum. Do it for each subset individually because factors repeat for each year
   ggplot() +
   geom_line(aes(Date, X1.Temp, color = "Bryum argenteum X1"))+  # Add a line that joins the points
   geom_line(aes(Date, X2.Temp, color = "Bryum argenteum X2"))+  # Add a line that joins the points
   geom_line(aes(Date, X3.Temp, color = "Austroplaca soropelta"))+  # Add a line that joins the points
   geom_line(aes(Date, X4.Temp, color = "Bryum argenteum X4"))+  # Add a line that joins the points
   geom_hline(yintercept = 0, color = "blue", linetype = "dashed") +
      scale_color_manual(values = c( "Austroplaca soropelta" = "#ff914d", 
                                  "Bryum argenteum X1" = "#119683", 
                                  "Bryum argenteum X2" = "#74c476", 
                                  "Bryum argenteum X4" = "#41ab5d")) +
   labs(x = "\nDate (day)", y = "TT (°C)") +
   theme_graphs_env_cond() +
    theme(axis.text.x = element_blank(), 
...
(PAR_plot_march_22_23 <- data_clean %>% 
  ...
  ggplot() +
   geom_line(aes(Date, X1.PAR, color = "Bryum argenteum X1"))+  # Add a line that joins the points
   geom_line(aes(Date, X2.PAR, color = "Bryum argenteum X2"))+  # Add a line that joins the points
   geom_line(aes(Date, X3.PAR, color = "Austroplaca soropelta"))+  # Add a line that joins the points
   geom_line(aes(Date, X4.PAR, color = "Bryum argenteum X4"))+  # Add a line that joins the points
  scale_color_manual(values = c( "Austroplaca soropelta" = "#ff914d", 
                                  "Bryum argenteum X1" = "#119683", 
                                  "Bryum argenteum X2" = "#74c476", 
                                  "Bryum argenteum X4" = "#41ab5d")) +
...
(Yield_plot_march_22_23 <- data_clean %>% 
   ...
   ggplot() +
   geom_point(aes(Datetime, X1.Y, color = "Bryum argenteum X1"))+  # Add a line that joins the points
   geom_point(aes(Datetime, X2.Y, color = "Bryum argenteum X2"))+  # Add a line that joins the points
   geom_point(aes(Datetime, X3.Y, color = "Austroplaca soropelta"))+  # Add a line that joins the points
   geom_point(aes(Datetime, X4.chosen_yield, color = "Bryum argenteum X4"))+  # Add a line that joins the points
   geom_line(aes(Datetime, X1.Y, color = "Bryum argenteum X1"))+  # Add a line that joins the points
   geom_line(aes(Datetime, X2.Y, color = "Bryum argenteum X2"))+  # Add a line that joins the points
   geom_line(aes(Datetime, X3.Y, color = "Austroplaca soropelta"))+  # Add a line that joins the points
   geom_line(aes(Datetime, X4.chosen_yield, color = "Bryum argenteum X4"))+  # Add a line that joins the points
      scale_color_manual(values = c( "Austroplaca soropelta" = "#ff914d", 
                                  "Bryum argenteum X1" = "#119683", 
                                  "Bryum argenteum X2" = "#74c476", 
                                  "Bryum argenteum X4" = "#41ab5d")) +
...
(ETR_plot_march_22_23 <- data_clean %>% 
   ...
   mutate(Date_Combined = reorder(Date_Combined, Day_cum)) %>%  # reorder the factors of Date_Combined according to the values of Day_cum. Do it for each subset individually because factors repeat for each year
   ggplot() +
   geom_line(aes(Date, X1.ETR, color = "Bryum argenteum X1"))+  # Add a line that joins the points
   geom_line(aes(Date, X2.ETR, color = "Bryum argenteum X2"))+  # Add a line that joins the points
   geom_line(aes(Date, X3.ETR, color = "Austroplaca soropelta"))+  # Add a line that joins the points
   geom_line(aes(Date, X4.chosen_ETR, color = "Bryum argenteum X4"))+  # Add a line that joins the points
   scale_color_manual(values = c( "Austroplaca soropelta" = "#ff914d", 
                                  "Bryum argenteum X1" = "#119683", 
                                  "Bryum argenteum X2" = "#74c476", 
                                  "Bryum argenteum X4" = "#41ab5d")) +
...
(Ft_plot_march_22_23 <- data_clean %>% 
   ...
   mutate(Date_Combined = reorder(Date_Combined, Day_cum)) %>%  # reorder the factors of Date_Combined according to the values of Day_cum. Do it for each subset individually because factors repeat for each year
   ggplot() +
   geom_line(aes(Date, X1.F, color = "Bryum argenteum X1"))+  # Add a line that joins the points
   geom_line(aes(Date, X2.F, color = "Bryum argenteum X2"))+  # Add a line that joins the points
   geom_line(aes(Date, X3.F, color = "Austroplaca soropelta"))+  # Add a line that joins the points
   geom_line(aes(Date, X4.F, color = "Bryum argenteum X4"))+  # Add a line that joins the points
      scale_color_manual(values = c( "Austroplaca soropelta" = "#ff914d", 
                                  "Bryum argenteum X1" = "#119683", 
                                  "Bryum argenteum X2" = "#74c476", 
                                  "Bryum argenteum X4" = "#41ab5d")) +
...
(Fm_plot_march_22_23 <- data_clean %>% 
   ...
   ggplot() +
   geom_line(aes(Date, X1.Fm, color = "Bryum argenteum X1"))+  # Add a line that joins the points
   geom_line(aes(Date, X2.Fm, color = "Bryum argenteum X2"))+  # Add a line that joins the points
   geom_line(aes(Date, X3.Fm, color = "Austroplaca soropelta"))+  # Add a line that joins the points
   geom_line(aes(Date, X4.Fm, color = "Bryum argenteum X4"))+  # Add a line that joins the points
      scale_color_manual(values = c( "Austroplaca soropelta" = "#ff914d", 
                                  "Bryum argenteum X1" = "#119683", 
                                  "Bryum argenteum X2" = "#74c476", 
                                  "Bryum argenteum X4" = "#41ab5d")) +
...
(Diff_plot_march_22_23 <- data_clean %>% 
   ...
   mutate(Date_Combined = reorder(Date_Combined, Day_cum)) %>%  # reorder the factors of Date_Combined according to the values of Day_cum. Do it for each subset individually because factors repeat for each year
   ggplot() +
   geom_line(aes(Date, X1.diff, color = "Bryum argenteum X1"))+  # Add a line that joins the points
   geom_line(aes(Date, X2.diff, color = "Bryum argenteum X2"))+  # Add a line that joins the points
   geom_line(aes(Date, X3.diff, color = "Austroplaca soropelta"))+  # Add a line that joins the points
   geom_line(aes(Date, X4.diff, color = "Bryum argenteum X4"))+  # Add a line that joins the points
      scale_color_manual(values = c( "Austroplaca soropelta" = "#ff914d", 
                                  "Bryum argenteum X1" = "#119683", 
                                  "Bryum argenteum X2" = "#74c476", 
                                  "Bryum argenteum X4" = "#41ab5d")) +
...
(yield_year_round_19_23 <- rbind(
  ...
  labs(color = "Species") + # This adds a legend for the colors
   ...
   theme(
     legend.position = "bottom",
    legend.text = element_text(size = 12, face = "bold"),  # Adjust the font size of legend text
    legend.title = element_text(size = 14, face = "bold")  # Adjust the font size of legend title
  ))  

ggsave(filename = "graphs_year_round/yield_year_round_19_23.png", yield_year_round_19_23, width = 16,height = 8, units = "cm",device = "png")  # Save graph

```
11.5. Rh plot

```{r}
(RH_year_round_19_23 <- data_met %>%
   mutate(Date.UTC = as.Date(Date.UTC, format="%d/%m/%Y")) %>% 
   group_by(Date.UTC) %>% 
   summarise(Rhmean = mean(Rhmean)) %>% # Calculate average Rh per day for clarity
  ggplot(aes(Date.UTC, Rhmean)) +
  geom_line() +
  theme_graphs_env_cond() +
  scale_x_date(date_breaks = "1 month", date_labels = "%m %Y") +
  scale_y_continuous(breaks = seq(30, 100, by = 15), limits = c(30, 100)) +
  ylab("RH %\n"))
...
(combined_plot_19_23 <- ( 
  (yield_year_round_19_23 + 
     theme(axis.text.x = element_blank(), 
           ...
           axis.text.y = element_text(face = "bold", size = 10),
           axis.title.x = element_blank(),
            legend.position = "none"))/ # use ggarrange to move legend 
  (temp_year_round_19_23_graph + 
     theme(axis.text.x = element_blank(), 
           axis.ticks.x = element_blank(), 
           axis.title = element_text(face = "bold", size = 12),
           axis.text.y = element_text(face = "bold", size = 10),
           axis.title.x = element_blank(), 
           legend.position = "none"))/
  (air_temp_year_round_19_23_graph + 
     theme(axis.text.x = element_blank(), 
           axis.ticks.x = element_blank(),
           axis.title = element_text(face = "bold", size = 12),
           axis.text.y = element_text(face = "bold", size = 10),
  ...
  ( RH_year_round_19_23 +
      theme(axis.text.x = element_blank(), 
           ...
           axis.text.y = element_text(face = "bold", size = 10),
            axis.title.x = element_blank()))/
  (PAR_year_round_19_23_graph + 
     theme(axis.text.x = element_text(angle = 45, hjust = 1, face = "bold", size = 10),
           axis.title = element_text(face = "bold", size = 12),
           axis.text.y = element_text(face = "bold", size = 10))) 
  & plot_layout(ncol = 1)))

#(combined_plot_19_23 <- ggarrange( (yield_year_round_19_23 + theme(axis.text.x = element_blank(), axis.ticks.x = element_blank(), axis.title.x = element_blank())), # use ggarrange to move legend 
#  (temp_year_round_19_23 + theme(axis.text.x = element_blank(), axis.ticks.x = element_blank(), axis.title.x = element_blank(), legend.position = "none")),
#  (air_temp_year_round_19_23 + theme(axis.text.x = element_blank(), axis.ticks.x = element_blank(), axis.title.x = element_blank())),
#  ( RH_year_round_19_23 +theme(axis.text.x = element_blank(), axis.ticks.x = element_blank(), axis.title.x = element_blank())),
#  (PAR_year_round_19_23 + theme(axis.text.x = element_text(angle = 45, hjust = 1))), ncol = 1, heights = c(1,1,1,1,1), common.legend = TRUE, legend = "bottom"))

ggsave(filename = "graphs_year_round/combined_plot_19_23.png", combined_plot_19_23, width = 16,height = 12, units = "cm",device = "png")  # Save graph
```


## 12. Graphs Temp-yield and RH-yield

12.1 Sample X3 (Lichen)

12.1.1 Temp-yield
```{r}
(graph_temp_y_19_22_X3 <- data_clean %>% 
  ggplot() +
  geom_point(aes(X3.Temp, X3.chosen_yield, color = "Austroplaca soropelta")) +
  theme_graphs_env_cond()+
  labs(x = "\nTemperature ºC", y = "Yield Lichen X3 ") +
   scale_color_manual(values = c( "Austroplaca soropelta" = "#ff914d")) +
  theme(axis.text.x = element_text(angle = 0),
        legend.position = "none"))

ggsave(filename = "graphs_characterise/austroplaca/graph_temp_y_19_22_X3.png", graph_temp_y_19_22_X3, width = 20,height = 20, units = "cm",device = "png")  # Save graph

(graph_temp_y_22_23_X3 <- summer_22_23 %>% 
  ggplot(aes(X3.Temp, X3.chosen_yield)) +
  geom_point() +
  theme_graphs_env_cond()+
  labs(x = "\nTemperature ºC", y = "Yield Lichen X3 ") +
  theme(axis.text.x = element_text(angle = 0)))

(graph_temp_y_all_period_X3 <- rbind(
  data_clean %>% 
    select(c(X3.Temp, X3.chosen_yield)),
  data_clean_23 %>% 
    select(c(X3.Temp, X3.chosen_yield))) %>% 
    ggplot()+
    geom_point(aes(X3.Temp, X3.chosen_yield, color = "Austroplaca soropelta")) +
...
ggsave(filename = "graphs_characterise/austroplaca/graph_temp_y_22_23_X3.png", graph_temp_y_22_23_X3, width = 16,height = 10, units = "cm",device = "png")  # Save graph
```
...
data_yield_rh <- full_join(data_clean %>%  # we want to plant info from different datasets. Join them in the same one first
    select(X1.Y, X2.Y, X3.chosen_yield, X4.chosen_yield, Date_no_time),  # select columns I am interested in
    data_met %>% 
    select(Rhmean, Date.UTC) %>% 
    mutate(Date_no_time = as.Date(Date.UTC, format = "%d/%m/%Y")) %>%  # filter so we have the same dates
    filter(Date_no_time > as.Date("16/01/2019", format = "%d/%m/%Y"),
           Date_no_time < as.Date("31/10/2022", format = "%d/%m/%Y")))

(graph_rh_y_all_period_X3 <- data_yield_rh %>%  #
  ggplot() + 
  geom_point(aes( Rhmean, X3.chosen_yield, color = "Austroplaca soropelta", fill = "Austroplaca soropelta", alpha = 0.1)) +
    # geom_polygon(aes(Rhmean, X3.chosen_yield, alpha = 0.1)) +
  theme_graphs_env_cond()+
  labs(x = "\nRH %", y = "Yield Lichen") +
        ylim(c(0.01, 0.8))+
    xlim(c(0, 100))+
...
ggsave(filename = "graphs_characterise/austroplaca/graph_rh_y_all_period_X3.png", graph_rh_y_all_period_X3, width = 16,height = 10, units = "cm",device = "png")  # Save graph
```

12.2. Sample X1 (moss)

```{r}
(graph_temp_y_19_22_moss <- data_clean %>% 
   filter(av_moss_yield > 0) %>% 
  ggplot(aes(av_moss_temp, av_moss_yield, color = "Bryum argenteum")) +
  geom_point() +
  theme_graphs_env_cond()+
  labs(x = "\nTemperature ºC", y = "Yield Average moss ") +
   scale_color_manual(values = c( "Bryum argenteum" = "#119683")) +
  theme(axis.text.x = element_text(angle = 0),
        legend.position = "none"))

ggsave(filename = "graphs_characterise/bryum/graph_temp_y_19_22_moss.png", graph_temp_y_19_22_moss, width = 16,height = 10, units = "cm",device = "png")  # Save graph

(graph_temp_y_22_23_X1 <- summer_22_23 %>% 
  ggplot(aes(av_moss_temp, av_moss_yield, color = "Bryum argenteum")) +
  geom_point() +
  theme_graphs_env_cond()+
  labs(x = "\nTemperature ºC", y = "Yield average moss ") +
...
ggsave(filename = "graphs_characterise/bryum/graph_temp_y_22_23_X1.png", graph_temp_y_22_23_X1, width = 16,height = 10, units = "cm",device = "png")  # Save graph

(graph_temp_y_all_period<- rbind(
  data_clean %>% 
    select(av_moss_temp, av_moss_yield),
  data_clean_23 %>% 
    select(av_moss_temp, av_moss_yield)) %>% 
   ggplot(aes(av_moss_temp, av_moss_yield, color = "Bryum argenteum")) +
  geom_point() +
...
ggsave(filename = "graphs_characterise/bryum/graph_temp_y_all_period.png", graph_temp_y_all_period, width = 16,height = 10, units = "cm",device = "png")  # Save graph
```

12.2.2. Rh-yield

```{r}
(graph_rh_y_all_period_moss <- data_yield_rh %>%  #
  ggplot() + 
  geom_point(aes( Rhmean, X1.Y, color = "Bryum argenteum", fill = "Austroplaca soropelta", alpha = 0.1)) +
    # geom_polygon(aes(Rhmean, X3.chosen_yield, alpha = 0.1)) +
  theme_graphs_env_cond()+
  labs(x = "\nRH %", y = "Yield moss ") +
    ylim(c(0.01, 0.8))+
...
ggsave(filename = "graphs_characterise/bryum/graph_rh_y_all_period_moss.png", graph_rh_y_all_period_moss, width = 16,height = 10, units = "cm",device = "png")  # Save graph
```

12.Conjoined graph yiel- RH/ temp

```{r}
# change asthetics
complete_graph_rh_temp_yield <- (
  (graph_temp_y_all_period_X3 +
    theme(axis.text.x = element_blank(),
          axis.ticks.x = element_blank(),
          axis.title.x = element_blank())) /
  (graph_rh_y_all_period_X3 +
    theme(axis.text.x = element_blank(),
          axis.ticks.x = element_blank(),
          axis.title = element_blank())) /
  (graph_temp_y_all_period) /
  (graph_rh_y_all_period_moss +
    theme(axis.title.y = element_blank()))
)

# Combine with patchwork::wrap_plots()
(complete_graph_rh_temp_yield <- complete_graph_rh_temp_yield +
  plot_layout(ncol = 2))

ggsave(filename = "graphs_env_conditions/complete_graph_rh_temp_yield.png", complete_graph_rh_temp_yield, width = 16,height = 10, units = "cm",device = "png")  # Save graph
...
## 13. Analysis under snow 

2019-2020

Snowmelt- 2nd-14th dec

```{r}
(temp_plot_19_20_undersnow_2_dec <- summer_19_20 %>% 
   filter (Day_cum > 43797 & Day_cum < 43817) %>%  # filter the 8th, 9th and 10th of jan
   ggplot() + 
   geom_line(aes(Date, X3.Temp, color = "Austroplaca soropelta"))+  # add a line that joins the points
    geom_line(aes(Date, X1.Temp, color = "Bryum argenteum X1"))+  # add a line that joins the points
    geom_line(aes(Date, X2.Temp, color = "Bryum argenteum X2"))+  # add a line that joins the points
...
(PAR_plot_19_20_undersnow_2_dec <- summer_19_20 %>%
  filter (Day_cum > 43797 & Day_cum < 43817) %>% # filter the 8th, 9th and 10th of jan
  ggplot() +
  geom_line(aes(Date, X3.PAR, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.PAR, color = "Bryum argenteum X1")) + # add a line that joins the points
  geom_line(aes(Date, X2.PAR, color = "Bryum argenteum X2"), alpha = 0.5) + # add a line that joins the points
  geom_line(aes(Date, X4.PAR, color = "Bryum argenteum X4"), alpha = 0.5) + # add a line that joins the points
  scale_color_manual(values = c(
    "Austroplaca soropelta" = "#ff914d",
    "Bryum argenteum X1" = "#119683",
    "Bryum argenteum X2" = "#74c476",
    "Bryum argenteum X4" = "#41ab5d"
  )) +
...
(Yield_plot_19_20_undersnow_2_dec <- summer_19_20 %>% 
  filter (Day_cum > 43797 & Day_cum < 43817) %>%  # filter the 8th, 9th and 10th of jan
  ggplot() +
  geom_line(aes(Date, X3.Y, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.Y, color = "Bryum argenteum X1")) + # add a line that joins the points
  geom_line(aes(Date, X2.Y, color = "Bryum argenteum X2", alpha = 0.5)) + # add a line that joins the points
  geom_line(aes(Date, X4.Y, color = "Bryum argenteum X4", alpha = 0.5)) +
  scale_color_manual(values = c(
    "Austroplaca soropelta" = "#ff914d",
    "Bryum argenteum X1" = "#119683",
    "Bryum argenteum X2" = "#74c476",
...
(ETR_plot_19_20_undersnow_2_dec <- summer_19_20 %>% 
  filter (Day_cum > 43797 & Day_cum < 43817) %>%  # filter the 8th, 9th and 10th of jan
  ggplot() +
  geom_line(aes(Date, X3.ETR, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.ETR, color = "Bryum argenteum X1")) + # add a line that joins the points
  geom_line(aes(Date, X2.ETR, color = "Bryum argenteum X2", alpha = 0.5)) + # add a line that joins the points
  geom_line(aes(Date, X4.ETR, color = "Bryum argenteum X4", alpha = 0.5)) +
  scale_color_manual(values = c(
    "Austroplaca soropelta" = "#ff914d",
    "Bryum argenteum X1" = "#119683",
    "Bryum argenteum X2" = "#74c476",
...
(combined_plot_19_20_undersnow_2_dec <- (ETR_plot_19_20_undersnow_2_dec
                                         /Yield_plot_19_20_undersnow_2_dec
                                         /temp_plot_19_20_undersnow_2_dec
                                         /PAR_plot_19_20_undersnow_2_dec) & plot_layout(ncol = 1))

ggsave(filename = "graphs_under_snow/combined_plot_19_20_undersnow_2_dec.png", combined_plot_19_20_undersnow_2_dec, width = 16,height = 12, units = "cm",device = "png")  # Save graph
```
...
snowfall 9th of jan
```{r}
(temp_plot_19_20_undersnow_9_jan <- summer_19_20 %>% 
   filter (Day_cum > 43837 & Day_cum < 43841) %>%  # filter the 8th, 9th and 10th of jan
   ggplot() + 
   geom_line(aes(Date, X3.Temp, color = "Austroplaca soropelta"))+  # add a line that joins the points
    geom_line(aes(Date, X1.Temp, color = "Bryum argenteum X1"))+  # add a line that joins the points
    geom_line(aes(Date, X2.Temp, color = "Bryum argenteum X2"))+  # add a line that joins the points
...
(PAR_plot_19_20_undersnow_9_jan <- summer_19_20 %>%
  filter (Day_cum > 43837 & Day_cum < 43841) %>% # filter the 8th, 9th and 10th of jan
  ggplot() +
  geom_line(aes(Date, X3.PAR, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.PAR, color = "Bryum argenteum X1")) + # add a line that joins the points
...
(Yield_plot_19_20_undersnow_9_jan <- summer_19_20 %>% 
  filter (Day_cum > 43837 & Day_cum < 43841) %>%  # filter the 8th, 9th and 10th of jan
  ggplot() +
  geom_line(aes(Date, X3.Y, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.Y, color = "Bryum argenteum X1")) + # add a line that joins the points
...
(ETR_plot_19_20_undersnow_9_jan <- summer_19_20 %>% 
  filter (Day_cum > 43837 & Day_cum < 43841) %>%  # filter the 8th, 9th and 10th of jan
  ggplot() +
  geom_line(aes(Date, X3.ETR, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.ETR, color = "Bryum argenteum X1")) + # add a line that joins the points
...
(combined_plot_19_20_undersnow_9_jan <- (ETR_plot_19_20_undersnow_9_jan
                                         /Yield_plot_19_20_undersnow_9_jan
                                         /temp_plot_19_20_undersnow_9_jan
                                         /PAR_plot_19_20_undersnow_9_jan) & plot_layout(ncol = 1))

ggsave(filename = "graphs_under_snow/combined_plot_19_20_undersnow_9_jan.png", combined_plot_19_20_undersnow_9_jan, width = 16,height = 12, units = "cm",device = "png")  # Save graph
```
Snowfall 14th, 15th , 16th of jan

```{r}
(temp_plot_19_20_undersnow_15_jan <- summer_19_20 %>% 
   filter (Day_cum > 43843 & Day_cum < 43847) %>%  # filter the 14th, 15th, 16th of jan
   ggplot() + 
   geom_line(aes(Date, X3.Temp, color = "Austroplaca soropelta"))+  # add a line that joins the points
    geom_line(aes(Date, X1.Temp, color = "Bryum argenteum X1"))+  # add a line that joins the points
    geom_line(aes(Date, X2.Temp, color = "Bryum argenteum X2"))+  # add a line that joins the points
...
(PAR_plot_19_20_undersnow_15_jan <- summer_19_20 %>%
  filter (Day_cum > 43843 & Day_cum < 43847) %>% # filter the 14th, 15th, 16th of jan
  ggplot() +
  geom_line(aes(Date, X3.PAR, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.PAR, color = "Bryum argenteum X1")) + # add a line that joins the points
...
(Yield_plot_19_20_undersnow_15_jan <- summer_19_20 %>% 
  filter (Day_cum > 43843 & Day_cum < 43847) %>%  # filter the 14th, 15th, 16th of jan
  ggplot() +
  geom_line(aes(Date, X3.Y, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.Y, color = "Bryum argenteum X1")) + # add a line that joins the points
...
(ETR_plot_19_20_undersnow_15_jan <- summer_19_20 %>% 
  filter (Day_cum > 43843 & Day_cum < 43847) %>%  # filter the 14th, 15th, 16th of jan
  ggplot() +
  geom_line(aes(Date, X3.ETR, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.ETR, color = "Bryum argenteum X1")) + # add a line that joins the points
...
(combined_plot_19_20_undersnow_15_jan <- (ETR_plot_19_20_undersnow_15_jan
                                         /Yield_plot_19_20_undersnow_15_jan
                                         /temp_plot_19_20_undersnow_15_jan
                                         /PAR_plot_19_20_undersnow_15_jan) & plot_layout(ncol = 1))

ggsave(filename = "graphs_under_snow/combined_plot_19_20_undersnow_15_jan.png", combined_plot_19_20_undersnow_15_jan, width = 16,height = 12, units = "cm",device = "png")  # Save graph

```

 Snowfall 31st of jan

```{r}
(temp_plot_19_20_undersnow_30_jan <- summer_19_20 %>% 
   filter (Day_cum > 43859 & Day_cum < 43863) %>%  # filter the 30th of jan
   ggplot() + 
   geom_line(aes(Date, X3.Temp, color = "Austroplaca soropelta"))+  # add a line that joins the points
    geom_line(aes(Date, X1.Temp, color = "Bryum argenteum X1"))+  # add a line that joins the points
    geom_line(aes(Date, X2.Temp, color = "Bryum argenteum X2"))+  # add a line that joins the points
...
(PAR_plot_19_20_undersnow_30_jan <- summer_19_20 %>%
  filter (Day_cum > 43859 & Day_cum < 43863) %>% # filter the 8th, 9th and 10th of december
  ggplot() +
  geom_line(aes(Date, X3.PAR, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.PAR, color = "Bryum argenteum X1")) + # add a line that joins the points
  geom_line(aes(Date, X2.PAR, color = "Bryum argenteum X2"), alpha = 0.5) + # add a line that joins the points
...
(Yield_plot_19_20_undersnow_30_jan <- summer_19_20 %>% 
  filter (Day_cum > 43859 & Day_cum < 43863) %>%  # filter the 30th of jan
  ggplot() +
  geom_line(aes(Date, X3.Y, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.Y, color = "Bryum argenteum X1")) + # add a line that joins the points
...
(ETR_plot_19_20_undersnow_30_jan <- summer_19_20 %>% 
  filter (Day_cum > 43859 & Day_cum < 43863) %>%  # filter the 30th of jan
  ggplot() +
  geom_line(aes(Date, X3.ETR, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.ETR, color = "Bryum argenteum X1")) + # add a line that joins the points
...
(combined_plot_19_20_undersnow_30_jan <- (ETR_plot_19_20_undersnow_30_jan
                                         /Yield_plot_19_20_undersnow_30_jan
                                         /temp_plot_19_20_undersnow_30_jan
                                         /PAR_plot_19_20_undersnow_30_jan) & plot_layout(ncol = 1))

ggsave(filename = "graphs_under_snow/combined_plot_19_20_undersnow_30_jan.png", combined_plot_19_20_undersnow_30_jan, width = 16,height = 12, units = "cm",device = "png")  # Save graph

```

snowfall end of teh year- 13th /14th of feb

```{r}
(temp_plot_19_20_undersnow_13_feb <- summer_19_20 %>% 
   filter (Day_cum > 43872 & Day_cum < 43882) %>%  # filter the 13th 14th of feb
   ggplot() + 
   geom_line(aes(Date, X3.Temp, color = "Austroplaca soropelta"))+  # add a line that joins the points
    geom_line(aes(Date, X1.Temp, color = "Bryum argenteum X1"))+  # add a line that joins the points
    geom_line(aes(Date, X2.Temp, color = "Bryum argenteum X2"))+  # add a line that joins the points
...
(PAR_plot_19_20_undersnow_13_feb <- summer_19_20 %>%
  filter (Day_cum > 43872 & Day_cum < 43882) %>% # filter the 13th 14th of feb
  ggplot() +
  geom_line(aes(Date, X3.PAR, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.PAR, color = "Bryum argenteum X1")) + # add a line that joins the points
...
(Yield_plot_19_20_undersnow_13_feb <- summer_19_20 %>% 
  filter (Day_cum > 43872 & Day_cum < 43882) %>%  # filter the 13th 14th of feb
  ggplot() +
  geom_line(aes(Date, X3.Y, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.Y, color = "Bryum argenteum X1")) + # add a line that joins the points
...
(ETR_plot_19_20_undersnow_13_feb <- summer_19_20 %>% 
  filter (Day_cum > 43872 & Day_cum < 43882) %>%  # filter the 13th 14th of feb
  ggplot() +
  geom_line(aes(Date, X3.ETR, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.ETR, color = "Bryum argenteum X1")) + # add a line that joins the points
...
(combined_plot_19_20_undersnow_13_feb <- (ETR_plot_19_20_undersnow_13_feb
                                         /Yield_plot_19_20_undersnow_13_feb
                                         /temp_plot_19_20_undersnow_13_feb
                                         /PAR_plot_19_20_undersnow_13_feb) & plot_layout(ncol = 1))

ggsave(filename = "graphs_under_snow/combined_plot_19_20_undersnow_13_feb.png", combined_plot_19_20_undersnow_13_feb, width = 16,height = 12, units = "cm",device = "png")  # Save graph
...
```{r}
(temp_plot_20_21_undersnow_10_dec <- summer_20_21 %>% 
   filter (Day_cum > 44163 & Day_cum < 44186) %>%  # filter the 13th 14th of feb
   ggplot() + 
   geom_line(aes(Date, X3.Temp, color = "Austroplaca soropelta"))+  # add a line that joins the points
    geom_line(aes(Date, X1.Temp, color = "Bryum argenteum X1"))+  # add a line that joins the points
    geom_line(aes(Date, X2.Temp, color = "Bryum argenteum X2"))+  # add a line that joins the points
...
(PAR_plot_20_21_undersnow_10_dec <- summer_20_21 %>%
  filter (Day_cum > 44163 & Day_cum < 44186) %>% # filter the 13th 14th of feb
  ggplot() +
  geom_line(aes(Date, X3.PAR, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.PAR, color = "Bryum argenteum X1")) + # add a line that joins the points
...
(Yield_plot_20_21_undersnow_10_dec <- summer_20_21 %>% 
  filter (Day_cum > 44163 & Day_cum < 44186) %>%  # filter the 13th 14th of feb
  ggplot() +
  geom_line(aes(Date, X3.chosen_yield, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.Y, color = "Bryum argenteum X1")) + # add a line that joins the points
  geom_line(aes(Date, X2.Y, color = "Bryum argenteum X2", alpha = 0.5)) + # add a line that joins the points
  geom_line(aes(Date, X4.Y, color = "Bryum argenteum X4", alpha = 0.5)) +
  scale_color_manual(values = c(
...
(ETR_plot_20_21_undersnow_10_dec <- summer_20_21 %>% 
  filter (Day_cum > 44163 & Day_cum < 44186) %>%  # filter the 13th 14th of feb
  ggplot() +
  geom_line(aes(Date, X3.chosen_ETR, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.ETR, color = "Bryum argenteum X1")) + # add a line that joins the points
  geom_line(aes(Date, X2.ETR, color = "Bryum argenteum X2", alpha = 0.5)) + # add a line that joins the points
  geom_line(aes(Date, X4.ETR, color = "Bryum argenteum X4", alpha = 0.5)) +
  scale_color_manual(values = c(
...
(combined_plot_20_21_undersnow_10_dec <- (ETR_plot_20_21_undersnow_10_dec
                                         /Yield_plot_20_21_undersnow_10_dec
                                         /temp_plot_20_21_undersnow_10_dec
                                         /PAR_plot_20_21_undersnow_10_dec) & plot_layout(ncol = 1))

ggsave(filename = "graphs_under_snow/combined_plot_20_21_undersnow_10_dec.png", combined_plot_20_21_undersnow_10_dec, width = 16,height = 12, units = "cm",device = "png")  # Save graph
...
```{r}
(temp_plot_20_21_undersnow_21_jan <- summer_20_21 %>% 
   filter (Day_cum > 44215 & Day_cum < 44219) %>%  # filter the 13th 14th of feb
   ggplot() + 
   geom_line(aes(Date, X3.Temp, color = "Austroplaca soropelta"))+  # add a line that joins the points
    geom_line(aes(Date, X1.Temp, color = "Bryum argenteum X1"))+  # add a line that joins the points
    geom_line(aes(Date, X2.Temp, color = "Bryum argenteum X2"))+  # add a line that joins the points
...
(PAR_plot_20_21_undersnow_21_jan <- summer_20_21 %>%
  filter (Day_cum > 44215 & Day_cum < 44219) %>% # filter the 13th 14th of feb
  ggplot() +
  geom_line(aes(Date, X3.PAR, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.PAR, color = "Bryum argenteum X1")) + # add a line that joins the points
...
(Yield_plot_20_21_undersnow_21_jan <- summer_20_21 %>% 
  filter (Day_cum > 44215 & Day_cum < 44219) %>%  # filter the 13th 14th of feb
  ggplot() +
  geom_line(aes(Date, X3.chosen_yield, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.Y, color = "Bryum argenteum X1")) + # add a line that joins the points
...
(ETR_plot_20_21_undersnow_21_jan <- summer_20_21 %>% 
  filter (Day_cum > 44215 & Day_cum < 44219) %>%  # filter the 13th 14th of feb
  ggplot() +
  geom_line(aes(Date, X3.chosen_ETR, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.ETR, color = "Bryum argenteum X1")) + # add a line that joins the points
...
(combined_plot_20_21_undersnow_21_jan <- (ETR_plot_20_21_undersnow_21_jan
                                         /Yield_plot_20_21_undersnow_21_jan
                                         /temp_plot_20_21_undersnow_21_jan
                                         /PAR_plot_20_21_undersnow_21_jan) & plot_layout(ncol = 1))

ggsave(filename = "graphs_under_snow/combined_plot_20_21_undersnow_21_jan.png", combined_plot_20_21_undersnow_21_jan, width = 16,height = 12, units = "cm",device = "png")  # Save graph
...
```{r}
(temp_plot_20_21_undersnow_29_jan <- summer_20_21 %>% 
   filter (Day_cum > 44223 & Day_cum < 44229) %>%  # filter the 13th 14th of feb
   ggplot() + 
   geom_line(aes(Date, X3.Temp, color = "Austroplaca soropelta"))+  # add a line that joins the points
    geom_line(aes(Date, X1.Temp, color = "Bryum argenteum X1"))+  # add a line that joins the points
    geom_line(aes(Date, X2.Temp, color = "Bryum argenteum X2"))+  # add a line that joins the points
...
(PAR_plot_20_21_undersnow_29_jan <- summer_20_21 %>%
  filter (Day_cum > 44223 & Day_cum < 44229) %>% # filter the 13th 14th of feb
  ggplot() +
  geom_line(aes(Date, X3.PAR, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.PAR, color = "Bryum argenteum X1")) + # add a line that joins the points
...
(Yield_plot_20_21_undersnow_29_jan <- summer_20_21 %>% 
  filter (Day_cum > 44223 & Day_cum < 44229) %>%  # filter the 13th 14th of feb
  ggplot() +
  geom_line(aes(Date, X3.chosen_yield, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.Y, color = "Bryum argenteum X1")) + # add a line that joins the points
...
(ETR_plot_20_21_undersnow_29_jan <- summer_20_21 %>% 
  filter (Day_cum > 44223 & Day_cum < 44229) %>%  # filter the 13th 14th of feb
  ggplot() +
  geom_line(aes(Date, X3.chosen_ETR, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.ETR, color = "Bryum argenteum X1")) + # add a line that joins the points
...
(combined_plot_20_21_undersnow_29_jan <- (ETR_plot_20_21_undersnow_29_jan
                                         /Yield_plot_20_21_undersnow_29_jan
                                         /temp_plot_20_21_undersnow_29_jan
                                         /PAR_plot_20_21_undersnow_29_jan) & plot_layout(ncol = 1))

ggsave(filename = "graphs_under_snow/combined_plot_20_21_undersnow_29_jan.png", combined_plot_20_21_undersnow_29_jan, width = 16,height = 12, units = "cm",device = "png")  # Save graph

```

Snowfall end of the year - 3rd feb

```{r}
(temp_plot_20_21_undersnow_3_feb <- summer_20_21 %>% 
   filter (Day_cum > 44229 & Day_cum < 44242) %>%  # filter the 13th 14th of feb
   ggplot() + 
   geom_line(aes(Date, X3.Temp, color = "Austroplaca soropelta"))+  # add a line that joins the points
    geom_line(aes(Date, X1.Temp, color = "Bryum argenteum X1"))+  # add a line that joins the points
    geom_line(aes(Date, X2.Temp, color = "Bryum argenteum X2"))+  # add a line that joins the points
...
(PAR_plot_20_21_undersnow_3_feb <- summer_20_21 %>%
  filter (Day_cum > 44229 & Day_cum < 44242) %>% # filter the 13th 14th of feb
  ggplot() +
  geom_line(aes(Date, X3.PAR, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.PAR, color = "Bryum argenteum X1")) + # add a line that joins the points
...
(Yield_plot_20_21_undersnow_3_feb <- summer_20_21 %>% 
  filter (Day_cum > 44229 & Day_cum < 44242) %>%  # filter the 13th 14th of feb
  ggplot() +
  geom_line(aes(Date, X3.chosen_yield, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.Y, color = "Bryum argenteum X1")) + # add a line that joins the points
...
(ETR_plot_20_21_undersnow_3_feb <- summer_20_21 %>% 
  filter (Day_cum > 44229 & Day_cum < 44242) %>%  # filter the 13th 14th of feb
  ggplot() +
  geom_line(aes(Date, X3.chosen_ETR, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.ETR, color = "Bryum argenteum X1")) + # add a line that joins the points
...
(combined_plot_20_21_undersnow_3_feb <- (ETR_plot_20_21_undersnow_3_feb
                                         /Yield_plot_20_21_undersnow_3_feb
                                         /temp_plot_20_21_undersnow_3_feb
                                         /PAR_plot_20_21_undersnow_3_feb) & plot_layout(ncol = 1))

ggsave(filename = "graphs_under_snow/combined_plot_20_21_undersnow_3_feb.png", combined_plot_20_21_undersnow_3_feb, width = 16,height = 12, units = "cm",device = "png")  # Save graph
...
```{r}
(temp_plot_21_22_undersnow_11_dec <- summer_21_22 %>% 
   filter (Day_cum > 44537 & Day_cum < 44544) %>%  # filter the 13th 14th of feb
   ggplot() + 
   geom_line(aes(Date, X3.Temp, color = "Austroplaca soropelta"))+  # add a line that joins the points
    geom_line(aes(Date, X1.Temp, color = "Bryum argenteum X1"))+  # add a line that joins the points
    geom_line(aes(Date, X2.Temp, color = "Bryum argenteum X2"))+  # add a line that joins the points
...
(PAR_plot_21_22_undersnow_11_dec <- summer_21_22 %>%
  filter (Day_cum > 44537 & Day_cum < 44544) %>% # filter the 13th 14th of feb
  ggplot() +
  geom_line(aes(Date, X3.PAR, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.PAR, color = "Bryum argenteum X1")) + # add a line that joins the points
  ...
  ylim(0, 1500) +
  labs(x = "\nDate 2021-2022 (day-month-year)", y = "PAR\n(µmol \nm-2 s^-1)") +
  theme_graphs_env_cond() +
  labs(color = "Species")+
  theme(legend.position = "bottom",
        legend.title = element_text(face = "bold", size = 10))+
...
(Yield_plot_21_22_undersnow_11_dec <- summer_21_22 %>% 
  filter (Day_cum > 44537 & Day_cum < 44544) %>%  # filter the 13th 14th of feb
  ggplot() +
  geom_line(aes(Date, X3.Y, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.Y, color = "Bryum argenteum X1")) + # add a line that joins the points
  geom_line(aes(Date, X2.Y, color = "Bryum argenteum X2", alpha = 0.5)) + # add a line that joins the points
  geom_line(aes(Date, X4.chosen_yield, color = "Bryum argenteum X4", alpha = 0.5)) +
  scale_color_manual(values = c(
    "Austroplaca soropelta" = "#ff914d",
    "Bryum argenteum X1" = "#119683",
    "Bryum argenteum X2" = "#74c476",
...
(ETR_plot_21_22_undersnow_11_dec <- summer_21_22 %>% 
  filter (Day_cum > 44537 & Day_cum < 44544) %>%  # filter the 13th 14th of feb
  ggplot() +
  geom_line(aes(Date, X3.ETR, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.ETR, color = "Bryum argenteum X1")) + # add a line that joins the points
  geom_line(aes(Date, X2.ETR, color = "Bryum argenteum X2", alpha = 0.5)) + # add a line that joins the points
  geom_line(aes(Date, X4.chosen_ETR, color = "Bryum argenteum X4", alpha = 0.5)) +
  scale_color_manual(values = c(
    "Austroplaca soropelta" = "#ff914d",
    "Bryum argenteum X1" = "#119683",
    "Bryum argenteum X2" = "#74c476",
...
(combined_plot_21_22_undersnow_11_dec <- (ETR_plot_21_22_undersnow_11_dec
                                         /Yield_plot_21_22_undersnow_11_dec
                                         /temp_plot_21_22_undersnow_11_dec
                                         /PAR_plot_21_22_undersnow_11_dec) & plot_layout(ncol = 1))

ggsave(filename = "graphs_under_snow/combined_plot_21_22_undersnow_11_dec.png", combined_plot_21_22_undersnow_11_dec, width = 16, height = 12, units = "cm",device = "png")  # Save graph
```

 Snowfall 31st December

```{r}
(temp_plot_21_22_undersnow_31_dec <- summer_21_22 %>% 
   filter (Day_cum > 44559 & Day_cum < 44563) %>%  # filter the 13th 14th of feb
   ggplot() + 
   geom_line(aes(Date, X3.Temp, color = "Austroplaca soropelta"))+  # add a line that joins the points
    geom_line(aes(Date, X1.Temp, color = "Bryum argenteum X1"))+  # add a line that joins the points
    geom_line(aes(Date, X2.Temp, color = "Bryum argenteum X2"))+  # add a line that joins the points
...
(PAR_plot_21_22_undersnow_31_dec <- summer_21_22 %>%
  filter (Day_cum > 44559 & Day_cum < 44563) %>% # filter the 13th 14th of feb
  ggplot() +
  geom_line(aes(Date, X3.PAR, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.PAR, color = "Bryum argenteum X1")) + # add a line that joins the points
...
(Yield_plot_21_22_undersnow_31_dec <- summer_21_22 %>% 
  filter (Day_cum > 44559 & Day_cum < 44563) %>%  # filter the 13th 14th of feb
  ggplot() +
  geom_line(aes(Date, X3.Y, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.Y, color = "Bryum argenteum X1")) + # add a line that joins the points
...
(ETR_plot_21_22_undersnow_31_dec <- summer_21_22 %>% 
  filter (Day_cum > 44559 & Day_cum < 44563) %>%  # filter the 13th 14th of feb
  ggplot() +
  geom_line(aes(Date, X3.ETR, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.ETR, color = "Bryum argenteum X1")) + # add a line that joins the points
...
(combined_plot_21_22_undersnow_31_dec <- (ETR_plot_21_22_undersnow_31_dec
                                         /Yield_plot_21_22_undersnow_31_dec
                                         /temp_plot_21_22_undersnow_31_dec
                                         /PAR_plot_21_22_undersnow_31_dec) & plot_layout(ncol = 1))

ggsave(filename = "graphs_under_snow/combined_plot_21_22_undersnow_31_dec.png", combined_plot_21_22_undersnow_31_dec, width = 16,height = 12, units = "cm",device = "png")  # Save graph
...
```{r}
(temp_plot_21_22_undersnow_10_jan <- summer_21_22 %>% 
   filter (Day_cum > 44569 & Day_cum < 44573) %>%  # filter the 13th 14th of feb
   ggplot() + 
   geom_line(aes(Date, X3.Temp, color = "Austroplaca soropelta"))+  # add a line that joins the points
    geom_line(aes(Date, X1.Temp, color = "Bryum argenteum X1"))+  # add a line that joins the points
    geom_line(aes(Date, X2.Temp, color = "Bryum argenteum X2"))+  # add a line that joins the points
...
(PAR_plot_21_22_undersnow_10_jan <- summer_21_22 %>%
  filter (Day_cum > 44569 & Day_cum < 44573) %>% # filter the 13th 14th of feb
  ggplot() +
  geom_line(aes(Date, X3.PAR, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.PAR, color = "Bryum argenteum X1")) + # add a line that joins the points
...
(Yield_plot_21_22_undersnow_10_jan <- summer_21_22 %>% 
  filter (Day_cum > 44569 & Day_cum < 44573) %>%  # filter the 13th 14th of feb
  ggplot() +
  geom_line(aes(Date, X3.Y, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.Y, color = "Bryum argenteum X1")) + # add a line that joins the points
...
(ETR_plot_21_22_undersnow_10_jan <- summer_21_22 %>% 
  filter (Day_cum > 44569 & Day_cum < 44573) %>%  # filter the 13th 14th of feb
  ggplot() +
  geom_line(aes(Date, X3.ETR, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.ETR, color = "Bryum argenteum X1")) + # add a line that joins the points
...
(combined_plot_21_22_undersnow_10_jan <- (ETR_plot_21_22_undersnow_10_jan
                                         /Yield_plot_21_22_undersnow_10_jan
                                         /temp_plot_21_22_undersnow_10_jan
                                         /PAR_plot_21_22_undersnow_10_jan) & plot_layout(ncol = 1))

ggsave(filename = "graphs_under_snow/combined_plot_21_22_undersnow_10_jan.png", combined_plot_21_22_undersnow_10_jan, width = 16,height = 12, units = "cm",device = "png")  # Save graph
...
```{r}
(temp_plot_21_22_undersnow_6_feb <- summer_21_22 %>% 
   filter (Day_cum > 44597 & Day_cum < 44600) %>%  # filter the 13th 14th of feb
   ggplot() + 
   geom_line(aes(Date, X3.Temp, color = "Austroplaca soropelta"))+  # add a line that joins the points
    geom_line(aes(Date, X1.Temp, color = "Bryum argenteum X1"))+  # add a line that joins the points
    geom_line(aes(Date, X2.Temp, color = "Bryum argenteum X2"))+  # add a line that joins the points
...
(PAR_plot_21_22_undersnow_6_feb <- summer_21_22 %>%
  filter (Day_cum > 44597 & Day_cum < 44600) %>% # filter the 13th 14th of feb
  ggplot() +
  geom_line(aes(Date, X3.PAR, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.PAR, color = "Bryum argenteum X1")) + # add a line that joins the points
...
(Yield_plot_21_22_undersnow_6_feb <- summer_21_22 %>% 
  filter (Day_cum > 44597 & Day_cum < 44600) %>%  # filter the 13th 14th of feb
  ggplot() +
  geom_line(aes(Date, X3.Y, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.Y, color = "Bryum argenteum X1")) + # add a line that joins the points
...
(ETR_plot_21_22_undersnow_6_feb <- summer_21_22 %>% 
  filter (Day_cum > 44597 & Day_cum < 44600) %>%  # filter the 13th 14th of feb
  ggplot() +
  geom_line(aes(Date, X3.ETR, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.ETR, color = "Bryum argenteum X1")) + # add a line that joins the points
...
(combined_plot_21_22_undersnow_6_feb <- (ETR_plot_21_22_undersnow_6_feb
                                         /Yield_plot_21_22_undersnow_6_feb
                                         /temp_plot_21_22_undersnow_6_feb
                                         /PAR_plot_21_22_undersnow_6_feb) & plot_layout(ncol = 1))


ggsave(filename = "graphs_under_snow/combined_plot_21_22_undersnow_6_feb.png", combined_plot_21_22_undersnow_6_feb, width = 16, height = 12, units = "cm",device = "png")  # Save graph

```

Snowfall end of the year

No activity under snow


```{r}
(temp_plot_21_22_undersnow_16_feb <- summer_21_22 %>% 
   filter (Day_cum > 44605 & Day_cum < 44612) %>%  # filter the 15th 21nd of feb
   ggplot() + 
   geom_line(aes(Date, X3.Temp, color = "Austroplaca soropelta"))+  # add a line that joins the points
    geom_line(aes(Date, X1.Temp, color = "Bryum argenteum X1"))+  # add a line that joins the points
    geom_line(aes(Date, X2.Temp, color = "Bryum argenteum X2"))+  # add a line that joins the points
...
(PAR_plot_21_22_undersnow_16_feb <- summer_21_22 %>%
  filter (Day_cum > 44605 & Day_cum < 44612) %>% # filter the 15th 21nd of feb
  ggplot() +
  geom_line(aes(Date, X3.PAR, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.PAR, color = "Bryum argenteum X1")) + # add a line that joins the points
...
(Yield_plot_21_22_undersnow_16_feb <- summer_21_22 %>% 
  filter (Day_cum > 44605 & Day_cum < 44612) %>%  # filter the 15th 21nd of feb
  ggplot() +
  geom_line(aes(Date, X3.Y, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.Y, color = "Bryum argenteum X1")) + # add a line that joins the points
...
(ETR_plot_21_22_undersnow_16_feb <- summer_21_22 %>% 
  filter (Day_cum > 44605 & Day_cum < 44612) %>%  # filter the 15th 21nd of feb
  ggplot() +
  geom_line(aes(Date, X3.ETR, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(Date, X1.ETR, color = "Bryum argenteum X1")) + # add a line that joins the points
  ...
  scale_color_manual(values = c(
   ...
   ylim(0, 150) +
   labs(x = "\nDate (day-month-year)", y = "ETR\n(μmol e- \nm−2s−1)") +
   theme_graphs_env_cond() +
    theme(axis.text.x = element_blank(),
        axis.title.x = element_blank(),
        legend.position = "none"))  # Remove axis label and text for the graph)

(combined_plot_21_22_undersnow_16_feb <- (ETR_plot_21_22_undersnow_16_feb
                                         /Yield_plot_21_22_undersnow_16_feb
                                         /temp_plot_21_22_undersnow_16_feb
                                         /PAR_plot_21_22_undersnow_16_feb) & plot_layout(ncol = 1))


ggsave(filename = "graphs_under_snow/combined_plot_21_22_undersnow_16_feb.png", combined_plot_21_22_undersnow_16_feb, width = 16,height = 12, units = "cm",device = "png")  # Save graph
...
```{r}
(temp_plot_22_23_undersnow_5_dec <- summer_22_23 %>% 
   filter (Day_cum > 44893 & Day_cum < 44901) %>%  # filter the 15th 21nd of feb
   ggplot() + 
   geom_line(aes(DateTime, X3.Temp, color = "Austroplaca soropelta"))+  # add a line that joins the points
    geom_line(aes(DateTime, X1.Temp, color = "Bryum argenteum X1"))+  # add a line that joins the points
    geom_line(aes(DateTime, X2.Temp, color = "Bryum argenteum X2"))+  # add a line that joins the points
    geom_line(aes(DateTime, X4.Temp, color = "Bryum argenteum X4"))+  # add a line that joins the points
   geom_hline(yintercept = 0, color = "blue", linetype = "dashed") +
   scale_color_manual(values = c( "Austroplaca soropelta" = "#ff914d", 
                                  "Bryum argenteum X1" = "#119683", 
                                  "Bryum argenteum X2" = "#74c476", 
...
(PAR_plot_22_23_undersnow_5_dec <- summer_22_23 %>%
  filter (Day_cum > 44893 & Day_cum < 44901) %>% # filter the 15th 21nd of feb
  ggplot() +
  geom_line(aes(DateTime, X3.PAR, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(DateTime, X1.PAR, color = "Bryum argenteum X1")) + # add a line that joins the points
  geom_line(aes(DateTime, X2.PAR, color = "Bryum argenteum X2"), alpha = 0.5) + # add a line that joins the points
  geom_line(aes(DateTime, X4.PAR, color = "Bryum argenteum X4"), alpha = 0.5) + # add a line that joins the points
  scale_color_manual(values = c(
    "Austroplaca soropelta" = "#ff914d",
    "Bryum argenteum X1" = "#119683",
    "Bryum argenteum X2" = "#74c476",
...
(Yield_plot_22_23_undersnow_5_dec <- summer_22_23 %>% 
  filter (Day_cum > 44893 & Day_cum < 44901) %>%  # filter the 15th 21nd of feb
  ggplot() +
  geom_line(aes(DateTime, X3.chosen_yield, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(DateTime, X1.Y, color = "Bryum argenteum X1")) + # add a line that joins the points
  geom_line(aes(DateTime, X2.Y, color = "Bryum argenteum X2", alpha = 0.5)) + # add a line that joins the points
  geom_line(aes(DateTime, X4.chosen_yield, color = "Bryum argenteum X4", alpha = 0.5)) +
  scale_color_manual(values = c(
    "Austroplaca soropelta" = "#ff914d",
    "Bryum argenteum X1" = "#119683",
    "Bryum argenteum X2" = "#74c476",
...
(ETR_plot_22_23_undersnow_5_dec <- summer_22_23 %>% 
  filter (Day_cum > 44893 & Day_cum < 44901) %>%  # filter the 15th 21nd of feb
  ggplot() +
  geom_line(aes(DateTime, X3.chosen_ETR, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(DateTime, X1.ETR, color = "Bryum argenteum X1")) + # add a line that joins the points
  geom_line(aes(DateTime, X2.ETR, color = "Bryum argenteum X2", alpha = 0.5)) + # add a line that joins the points
  geom_line(aes(DateTime, X4.chosen_ETR, color = "Bryum argenteum X4", alpha = 0.5)) +
  scale_color_manual(values = c(
    "Austroplaca soropelta" = "#ff914d",
    "Bryum argenteum X1" = "#119683",
    "Bryum argenteum X2" = "#74c476",
...
(combined_plot_22_23_undersnow_5_dec <- (ETR_plot_22_23_undersnow_5_dec
                                         /Yield_plot_22_23_undersnow_5_dec
                                         /temp_plot_22_23_undersnow_5_dec
                                         /PAR_plot_22_23_undersnow_5_dec) & plot_layout(ncol = 1))

ggsave(filename = "graphs_under_snow/combined_plot_22_23_undersnow_5_dec.png", combined_plot_22_23_undersnow_5_dec, width = 16,height = 12, units = "cm",device = "png")  # Save graph
...
```{r}
(temp_plot_22_23_undersnow_2_jan <- summer_22_23 %>% 
   filter (Day_cum > 44926 & Day_cum < 44931) %>%  # filter the 15th 21nd of feb
   ggplot() + 
   geom_line(aes(DateTime, X3.Temp, color = "Austroplaca soropelta"))+  # add a line that joins the points
    geom_line(aes(DateTime, X1.Temp, color = "Bryum argenteum X1"))+  # add a line that joins the points
    geom_line(aes(DateTime, X2.Temp, color = "Bryum argenteum X2"))+  # add a line that joins the points
...
(PAR_plot_22_23_undersnow_2_jan <- summer_22_23 %>%
  filter (Day_cum > 44926 & Day_cum < 44931) %>% # filter the 15th 21nd of feb
  ggplot() +
  geom_line(aes(DateTime, X3.PAR, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(DateTime, X1.PAR, color = "Bryum argenteum X1")) + # add a line that joins the points
...
(Yield_plot_22_23_undersnow_2_jan <- summer_22_23 %>% 
  filter (Day_cum > 44926 & Day_cum < 44931) %>%  # filter the 15th 21nd of feb
  ggplot() +
  geom_line(aes(DateTime, X3.chosen_yield, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(DateTime, X1.Y, color = "Bryum argenteum X1")) + # add a line that joins the points
...
(ETR_plot_22_23_undersnow_2_jan <- summer_22_23 %>% 
  filter (Day_cum > 44926 & Day_cum < 44931) %>%  # filter the 15th 21nd of feb
  ggplot() +
  geom_line(aes(DateTime, X3.chosen_ETR, color = "Austroplaca soropelta")) + # add a line that joins the points
  geom_line(aes(DateTime, X1.ETR, color = "Bryum argenteum X1")) + # add a line that joins the points
...
(combined_plot_22_23_undersnow_2_jan <- (ETR_plot_22_23_undersnow_2_jan
                                         /Yield_plot_22_23_undersnow_2_jan
                                         /temp_plot_22_23_undersnow_2_jan
                                         /PAR_plot_22_23_undersnow_2_jan) & plot_layout(ncol = 1))

ggsave(filename = "graphs_under_snow/combined_plot_22_23_undersnow_2_jan.png", combined_plot_22_23_undersnow_2_jan, width = 16,height = 12, units = "cm",device = "png")  # Save graph

```

Snowfall end of the year

no activity sin jan and no snow until teh end of feb
...
(temp_plot_19_20_results <- summer_19_20 %>% 
  ggplot() +
  geom_line(aes(Date, X3.Temp, color = "Austroplaca soropelta")) +  # add a line that joins the points
  geom_line(aes(Date, av_moss_temp, color = "Bryum argenteum")) +  # add a line that joins the points           
  geom_hline(yintercept = 0, color = "blue", linetype = "dashed") +
  geom_segment(aes(x = as.POSIXct("2019-11-29 00:53:00"), y = 15, xend = as.POSIXct("2019-12-01 00:53:00"), yend = 2),
               arrow = arrow(length = unit(0.5, "cm")), size = 1, color = "#FFCC00") + # add arrow for snowmelting event
  geom_segment(aes(x = as.POSIXct("2020-01-07 00:53:00"), y = 15, xend = as.POSIXct("2020-01-09 00:53:00"), yend = 2),
               arrow = arrow(length = unit(0.5, "cm")), size = 1, color = "brown") + # add arrow for short snowfall event
  geom_segment(aes(x = as.POSIXct("2020-02-17 00:53:00"), y = 15, xend = as.POSIXct("2020-02-15 00:53:00"), yend = 2),
               arrow = arrow(length = unit(0.5, "cm")), size = 1, color = "darkblue") + # add arrow for final snowfall event
  labs(x = "\nDate (day)", y = "TT (ºC) ") +
  scale_color_manual(values = c("Bryum argenteum" = "#119683", "Austroplaca soropelta" = "#ff914d")) +
  theme_graphs_env_cond() +
  theme(axis.text.x = element_blank(), 
...
(PAR_plot_19_20_results <- summer_19_20 %>% 
   ggplot() +
   geom_line(aes(Date, X3.PAR, color = "Austroplaca soropelta")) +  # add a line that joins the points
   geom_line(aes(Date, av_moss_PAR, color = "Bryum argenteum")) +  # add a line that joins the points
   geom_segment(aes(x = as.POSIXct("2019-11-29 00:53:00"), y = 700, xend = as.POSIXct("2019-12-01 00:53:00"), yend = 200),
                arrow = arrow(length = unit(0.5, "cm")), size = 1, color = "#FFCC00") + # add arrow for snowmelting event
   geom_segment(aes(x = as.POSIXct("2020-01-07 00:53:00"), y = 700, xend = as.POSIXct("2020-01-09 00:53:00"), yend = 200), arrow = arrow(length = unit(0.5, "cm")), size = 1, color = "brown") + # add arrow for snowmelting event
   geom_segment(aes(x = as.POSIXct("2020-02-17 00:53:00"), y = 700, xend = as.POSIXct("2020-02-15 00:53:00"), yend = 200), arrow = arrow(length = unit(0.5, "cm")), size = 1, color = "darkblue") + # add arrow for short snowfall event
    labs(x = "\nDate 2019-2020 (day-month-year)", y = "PAR\n(µmol \nm-2 s^-1)") +
   scale_color_manual(values = c("Bryum argenteum" = "#119683", "Austroplaca soropelta" = "#ff914d")) +
...
(Yield_plot_19_20_results<- summer_19_20 %>% 
   ggplot() +
   geom_line(aes(Date, X3.Y, color = "Austroplaca soropelta"))+  # Add a line that joins the points
   geom_line(aes(Date, av_moss_yield, color = "Bryum argenteum"))+  # Add a line that joins the points
   labs(x = "\nDate (day)", y = "Yield ") +
    scale_color_manual(values = c("Bryum argenteum" = "#119683", "Austroplaca soropelta" = "#ff914d")) +
   theme_graphs_env_cond() +
      ylim(0, 0.8) +
...
(ETR_plot_19_20_results <- summer_19_20 %>% 
   ggplot() +
   geom_line(aes(Date, X3.ETR, color = "Austroplaca soropelta"))+  # Add a line that joins the points
   geom_line(aes(Date, av_moss_ETR, color = "Bryum argenteum"))+  # Add a line that joins the points
   labs(x = "\nDate (day)", y = "ETR\n(μmol e- \nm−2s−1) ") +
    scale_color_manual(values = c("Bryum argenteum" = "#119683", "Austroplaca soropelta" = "#ff914d")) +
   theme_graphs_env_cond() +
    theme(axis.text.x = element_blank(), 
...
(combined_plot_19_20_results <- (ETR_plot_19_20_results/Yield_plot_19_20_results/temp_plot_19_20_results/(PAR_plot_19_20_results + theme(axis.text.x = element_text(angle = 45, hjust = 1))) & plot_layout(ncol = 1))) 

ggsave(filename = "graphs_characterise/combined_plot_19_20_results.png", combined_plot_19_20_results, width = 16,height = 10, units = "cm", device = "png")  # Save graph
```
...
ggsave(filename = "graphs_under_snow/combined_plot_19_20_undersnow_2_dec.png", combined_plot_19_20_undersnow_2_dec, width = 16,height = 16, units = "cm",device = "png")  # Save graph
```
...
ggsave(filename = "graphs_under_snow/combined_plot_19_20_undersnow_9_jan.png", combined_plot_19_20_undersnow_9_jan, width = 16,height = 16, units = "cm",device = "png")  # Save graph
```
...
ggsave(filename = "graphs_under_snow/combined_plot_19_20_undersnow_13_feb.png", combined_plot_19_20_undersnow_13_feb, width = 16,height = 16, units = "cm",device = "png")  # Save graph
...
### 14.1. 2021-2022
```{r}
(temp_plot_21_22_results <- summer_21_22 %>% 
  ggplot() +
  geom_line(aes(Date, X3.Temp, color = "Austroplaca soropelta")) +  # add a line that joins the points
  geom_line(aes(Date, av_moss_temp, color = "Bryum argenteum")) +  # add a line that joins the points           
  geom_hline(yintercept = 0, color = "blue", linetype = "dashed") +
  geom_segment(aes(x = as.POSIXct("2021-12-09 00:53:00"), y = 15, xend = as.POSIXct("2021-12-11 00:53:00"), yend = 2),
               arrow = arrow(length = unit(0.5, "cm")), size = 1, color = "#FFCC00") + # add arrow for snowmelting event
  geom_segment(aes(x = as.POSIXct("2021-12-29 00:53:00"), y = 15, xend = as.POSIXct("2021-12-31 00:53:00"), yend = 2),
               arrow = arrow(length = unit(0.5, "cm")), size = 1, color = "brown") + # add arrow for short snowfall event
  geom_segment(aes(x = as.POSIXct("2022-02-18 00:53:00"), y = 15, xend = as.POSIXct("2022-02-16 00:53:00"), yend = 2),
               arrow = arrow(length = unit(0.5, "cm")), size = 1, color = "darkblue") + # add arrow for final snowfall event
  labs(x = "\nDate (day)", y = "TT (ºC) ") +
  scale_color_manual(values = c("Bryum argenteum" = "#119683", "Austroplaca soropelta" = "#ff914d")) +
  theme_graphs_env_cond() +
...
(PAR_plot_21_22_results <- summer_21_22 %>% 
   ggplot() +
   geom_line(aes(Date, X3.PAR, color = "Austroplaca soropelta")) +  # add a line that joins the points
   geom_line(aes(Date, av_moss_PAR, color = "Bryum argenteum")) +  # add a line that joins the points
   geom_segment(aes(x = as.POSIXct("2021-12-09 00:53:00"), y = 700, xend = as.POSIXct("2021-12-11 00:53:00"), yend = 100),
                arrow = arrow(length = unit(0.5, "cm")), size = 1, color = "#FFCC00") + # add arrow for snowmelting event
   geom_segment(aes(x = as.POSIXct("2021-12-29 00:53:00"), y = 700, xend = as.POSIXct("2021-12-31 00:53:00"), yend = 100), arrow = arrow(length = unit(0.5, "cm")), size = 1, color = "brown") + # add arrow for snowmelting event
   geom_segment(aes(x = as.POSIXct("2022-02-18 00:53:00"), y = 700, xend = as.POSIXct("2022-02-16 00:53:00"), yend = 100), arrow = arrow(length = unit(0.5, "cm")), size = 1, color = "darkblue") + # add arrow for short snowfall event
    labs(x = "\nDate 2021-2022 (day-month-year)", y = "PAR\n(µmol \nm-2 s^-1)") +
   scale_color_manual(values = c("Bryum argenteum" = "#119683", "Austroplaca soropelta" = "#ff914d")) +
     scale_x_datetime(date_breaks = "1 week", date_labels = "%d %m %Y") +
    theme_graphs_env_cond()+
...
(Yield_plot_21_22_results<- summer_21_22 %>% 
   ggplot() +
   geom_line(aes(Date, X3.Y, color = "Austroplaca soropelta"))+  # Add a line that joins the points
   geom_line(aes(Date, av_moss_yield, color = "Bryum argenteum"))+  # Add a line that joins the points
   labs(x = "\nDate (day)", y = "Yield ") +
...
(ETR_plot_21_22_results <- summer_21_22 %>% 
   ggplot() +
   geom_line(aes(Date, X3.ETR, color = "Austroplaca soropelta"))+  # Add a line that joins the points
   geom_line(aes(Date, av_moss_ETR, color = "Bryum argenteum"))+  # Add a line that joins the points
   labs(x = "\nDate (day)", y = "ETR\n(μmol e- \nm−2s−1) ") +
...
(combined_plot_21_22_results <- (ETR_plot_21_22_results/Yield_plot_21_22_results/temp_plot_21_22_results/(PAR_plot_21_22_results + theme(axis.text.x = element_text(angle = 45, hjust = 1))) & plot_layout(ncol = 1))) 

ggsave(filename = "graphs_characterise/combined_plot_21_22_results.png", combined_plot_21_22_results, width = 16,height = 10, units = "cm", device = "png")  # Save graph
...
(temp_plot_21_22_undersnow_11_dec <- summer_21_22 %>% 
   ...
   scale_color_manual(values = c(
    "Austroplaca soropelta" = "#ff914d",
    "Bryum argenteum X1" = "green1",
    "Bryum argenteum X2" = "#35B779FF",
    "Bryum argenteum X4" = "olivedrab4")) +
   labs(x = "\nDate (day)", y = "Thallus \nTemperature \n(ºC) X3 ") +
   theme_graphs_env_cond()+
   ylim(-10, 10) +
   theme(axis.text.x = element_blank(),
...
(PAR_plot_21_22_undersnow_11_dec <- summer_21_22 %>%
  ...
  ylim(0, 1500) +
  labs(x = "\nDate 2021-2022 (day-month-year)", y = "PAR X3\n(µmol m-2 s^-1)") +
  theme_graphs_env_cond() +
    theme(legend.position = "bottom"))
...
ggsave(filename = "graphs_under_snow/combined_plot_21_22_undersnow_11_dec.png", combined_plot_21_22_undersnow_11_dec, width = 40,height = 20, units = "cm",device = "png")  # Save graph
```
 Snowfall 31st December
...
ggsave(filename = "graphs_under_snow/combined_plot_21_22_undersnow_31_dec.png", combined_plot_21_22_undersnow_31_dec, width = 40,height = 20, units = "cm",device = "png")  # Save graph
...
ggsave(filename = "graphs_under_snow/combined_plot_21_22_undersnow_16_feb.png", combined_plot_21_22_undersnow_16_feb, width = 40,height = 20, units = "cm",device = "png")  # Save graph

```
###


Graph closeup daily PAR

```{r}
#(PAR_closup_22_23 <- rbind(
  #data_clean %>% 
   # select(Date, X1.PAR, X2.PAR, X3.PAR, X4.PAR, Day_cum),
 # data_clean_23 %>% 
#  select(DateTime, X1.PAR, X2.PAR, X3.PAR, X4.PAR, Day_cum, Date)) %>%
#  mutate(mean_PAR = rowMeans(select(., c("X1.PAR", "X2.PAR", "X3.PAR", "X4.PAR")), na.rm = TRUE)) %>%  # calculate mean PAR across all samples
#   filter(Day_cum > 44906 & Day_cum < 44910) %>% 
#  ggplot() +  # plot it
#  geom_line(aes(DateTime, mean_PAR)) +
#  geom_vline(aes(xintercept = as.numeric(Date)))+ # Add vertical lines at midnight
#  theme_graphs_env_cond() +
#  scale_x_datetime(date_breaks = "3 hours") +
#  ylab("Average PAR\n(µmol m-2 s^-1)\n") +
# xlab("Date") +
#  theme(axis.text.x = element_text(face = "bold",size = 11, angle = 45, vjust = 1, hjust = 1))+
#   theme(axis.text = element_text(face = "bold", size = 12),  # Adjust the size as needed
 #         axis.title = element_text(face = "bold", size = 14),
 #       legend.text = element_text(face = "bold", size= 14)))

# Calculate standard deviation
data_clean_23_PAR <- data_clean_23 %>%
  filter(Day_cum > 44906 & Day_cum < 44910) %>%
  mutate(mean_PAR = rowMeans(select(., c("X1.PAR", "X2.PAR", "X3.PAR", "X4.PAR")), na.rm = TRUE),
         sd_PAR = apply(select(., c("X1.PAR", "X2.PAR", "X3.PAR", "X4.PAR")), 1, sd, na.rm = TRUE))

# Plot with standard deviation and shadow effect
(PAR_closup_22_23 <- ggplot(data_clean_23_PAR, aes(DateTime)) +
  geom_ribbon(aes(ymin = mean_PAR - sd_PAR, ymax = mean_PAR + sd_PAR), fill = "gray80") +  # Add shaded area for standard deviation
  geom_line(aes(y = mean_PAR), color = "black", size = 0.5) +  # Add mean line
...
ggsave(filename = "graphs_env_conditions/PAR_closup_22_23.png", PAR_closup_22_23, width = 16,height = 8, units = "cm",device = "png")  # Save graph
...
# Plot with standard deviation and shadow effect
#(PAR_closup_22_23 <- data_met %>% 
#    filter(Date.UTC) %>% 
#    ggplot() +
  #geom_ribbon(aes(ymin = mean_PAR - sd_PAR, ymax = mean_PAR + sd_PAR), fill = "gray80") +  # Add shaded area for standard deviation
#  geom_line(aes(x = DateTime, y = Tmean), color = "black", size = 0.5) +  # Add mean line
#  theme_graphs_env_cond() +
#  scale_x_datetime(date_breaks = "3 hours") +
#  ylab("Average T\n(ºC)\n") +
#  xlab("Date") +
...
Graph daily PAR - **NOT use it** just to test theory
```{r}
(PAR_closeupn_22_23_X1 <- summer_22_23 %>% 
    filter(Day_cum < 44925 & Day_cum > 44921) %>% # filter days before the 10th of December (when the difference isn't clear)
   ggplot(aes(DateTime, X1.PAR)) +
   geom_point()+  # Add points for the data
   geom_line()+  # Add a line that joins the points
   labs(x = "\nDate (day)", y = "PAR \nMoss X1 ") +
   theme_graphs_env_cond() +
...
(combined_closeup_22_23_X1 <-(PAR_closeupn_22_23_X1/Yield_closeupn_22_23_X1) & plot_layout(ncol = 1))
```


```{r}
unique(data_met %>% filter(Tmean >0) %>% 
  select(Month))
...
```{r}
(graph_PAR_Yield_X3 <-  rbind(
  data_clean %>% 
    select(X3.PAR, av_moss_PAR, X3.chosen_yield, av_moss_yield),
  data_clean_23 %>% 
    select(X3.PAR, av_moss_PAR, X3.chosen_yield, av_moss_yield))%>%
   filter(X3.chosen_yield >0,
          X3.PAR >0) %>% 
  ggplot()+
  geom_point(aes(X3.PAR, X3.chosen_yield, color = "Austroplaca soropelta"), alpha = 0.7) +
   geom_smooth(aes(X3.PAR, X3.chosen_yield, color = "Austroplaca soropelta"), alpha = 0.7) +
   theme_classic()+
   scale_color_manual(values = c("Bryum argenteum" = "#119683", "Austroplaca soropelta" = "#ff914d")))
  
# not reliable, not saturation
