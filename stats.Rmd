...
write.xlsx(month_activetime_stats_X1, file = "stats/bryum/month_activetime_stats_X1.xlsx") # save table
...
write.xlsx(month_activetime_stats_X2, file = "stats/bryum/month_activetime_stats_X2.xlsx") # save table
...
write.xlsx(month_activetime_stats_X4, file = "stats/bryum/month_activetime_stats_X4.xlsx") # save table
...
```{r}
(month_Y_stats_X4_1 <- bind_rows(  # Monthly stats fro total measuring period
  summer_19_20 %>% filter(Month == 11),
  summer_19_20 %>% filter(Month == 12),
  summer_19_20 %>% filter(Month == 1),
  summer_19_20 %>% filter(Month == 2),
...
(month_Y_stats_X4_2 <- bind_rows(
  ...
  summer_22_23 %>% filter(Month == 2)) %>% 
   group_by(Year, Month) %>% 
 summarise(mean_Y= mean(X4.chosen_yield),
            max_Y = max(X4.chosen_yield),  # get the maximum temperature
            min_Y = min(X4.chosen_yield)))

month_Y_stats_X4 <- bind_rows(month_Y_stats_X4_1, month_Y_stats_X4_2)

write.xlsx(month_Y_stats_X4, file = "stats/bryum/month_Y_stats_X4.xlsx") # save table

(month_ETR_stats_X4_1 <- bind_rows(  # Monthly stats fro total measuring period
  summer_19_20 %>% filter(Month == 11),
  summer_19_20 %>% filter(Month == 12),
  summer_19_20 %>% filter(Month == 1),
  summer_19_20 %>% filter(Month == 2),
...
(month_ETR_stats_X4_2 <- bind_rows(  # Monthly stats fro total measuring period
summer_21_22 %>% filter(Month == 11),
  summer_21_22 %>% filter(Month == 12),
  summer_21_22 %>% filter(Month == 1),
  summer_21_22 %>% filter(Month == 2),
  ...
  summer_22_23 %>% filter(Month == 2)) %>% 
   group_by(Year, Month) %>% 
 summarise(mean_ETR= mean(X4.chosen_ETR),
            max_ETR = max(X4.chosen_ETR),  # get the maximum temperature
            min_ETR = min(X4.chosen_ETR)))

month_ETR_stats_X4 <- bind_rows(month_ETR_stats_X4_1, month_ETR_stats_X4_2)
...
(table_general <- data.frame(
  ...
  Austroplaca_X3 = c(
    ...
    pull(mean_Temp_X3), pull(min_Temp_X3), pull(max_Temp_X3),
    pull(mean_Temp_active_X3), pull(min_Temp_active_X3),
    pull(max_Temp_active_X3), pull(mean_PAR_active_X3),
    pull(max_PAR_active_X3), pull(max_Y_active_X3),
    pull(mean_Y_active_X3), pull(mean_ETR_active_X3),
    pull(max_ETR_active_X3), 0, 0, 0, 0
  ),
  Bryum_X1 = c(
    pull(total_active_hours_X1), pull(Percentage_active_hours_X1), 
    pull(mean_Temp_X1), pull(min_Temp_X1), pull(max_Temp_X1),
    pull(mean_Temp_active_X1), pull(min_Temp_active_X1),
    pull(max_Temp_active_X1), pull(mean_PAR_active_X1),
    pull(max_PAR_active_X1), pull(max_Y_active_X1),
    pull(mean_Y_active_X1), pull(mean_ETR_active_X1),
    pull(max_ETR_active_X1), 0, 0, 0, 0
  ),
  Bryum_X2 = c(
    pull(total_active_hours_X2), pull(Percentage_active_hours_X2), 
    pull(mean_Temp_X2), pull(min_Temp_X2), pull(max_Temp_X2),
    pull(mean_Temp_active_X2), pull(min_Temp_active_X2),
    pull(max_Temp_active_X2), pull(mean_PAR_active_X2),
    pull(max_PAR_active_X2), pull(max_Y_active_X2),
    pull(mean_Y_active_X2), pull(mean_ETR_active_X2),
    pull(max_ETR_active_X2), 0, 0, 0, 0
    ),
 Bryum_X4 = c(
    pull(total_active_hours_X4), pull(Percentage_active_hours_X4),
    pull(mean_Temp_X4), pull(min_Temp_X4), pull(max_Temp_X4),
    pull(mean_Temp_active_X4), pull(min_Temp_active_X4),
    pull(max_Temp_active_X4), pull(mean_PAR_active_X4),
    pull(max_PAR_active_X4), pull(max_Y_active_X4),
    pull(mean_Y_active_X4), pull(mean_ETR_active_X4),
    pull(max_ETR_active_X4), 0, 0, 0, 0
  ),
  Bryum_average = c(
    ...
    pull(max_ETR_active_moss), 0, 0, 0, 0
  )))
