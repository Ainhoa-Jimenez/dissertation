...
write.xlsx(month_activetime_stats_X3, file = "stats/austroplaca/month_activetime_stats_X3.xlsx") # save table
...
(mean_Temp_X3_data <- bind_rows(  # Make into a single dataset
  ...
  summarise( n = n(),
    ...
    sd_temp = sd(X3.Temp)))  # calculate the mean Temp of the active period
...
(mean_Temp_X3_data <- bind_rows(
  ...
  summarise(mean_temp = mean(X3.Temp),
            ...
            sd_temp = sd(X3.Temp)))  # get the minimum temperature

mean_Temp_X3 <- mean_Temp_X3_data %>% 
  select( mean_temp)

max_Temp_X3 <- mean_Temp_X3_data %>% 
  select( max_temp)

min_Temp_X3 <- mean_Temp_X3_data %>% 
  select( min_temp)

sd_Temp_X3 <- mean_Temp_X3_data %>% 
  select( sd_temp)
...
(max_Temp_active_X3 <- mean_Temp_active_X3_data %>%  # extract the mean Temp of the active period
  filter( X3.Active == TRUE) %>% 
  select( max_temp))

(min_Temp_active_X3 <- mean_Temp_active_X3_data %>%  # extract the mean Temp of the active period
  filter( X3.Active == TRUE) %>% 
  select( min_temp))

(sd_Temp_active_X3 <- mean_Temp_active_X3_data %>%  # extract the mean Temp of the active period
  filter( X3.Active == TRUE) %>% 
  select( sd_temp))
...
(min_Temp_X3_19_20 <- mean_Temp_stats_X3_19_20 %>%  # extract the min Temp of the active period
    select(min_temp)) 
(sd_Temp_X3_19_20 <- mean_Temp_stats_X3_19_20 %>%  # extract the min Temp of the active period
    select(sd_temp))
...
(sd_Temp_active_X3_19_20 <- mean_Temp_active_stats_X3_19_20 %>%  # extract the mean Temp of the active period
  filter( X3.Active == TRUE) %>% 
  select( sd_temp))
...
(min_Temp_X3_20_21 <- mean_Temp_stats_X3_20_21 %>%  # extract the min Temp of the active period
    select(min_temp)) 
(sd_Temp_X3_20_21 <- mean_Temp_stats_X3_20_21 %>%  # extract the min Temp of the active period
    select(sd_temp)) 
...
(sd_Temp_active_X3_20_21 <- mean_Temp_active_stats_X3_20_21 %>%  # extract the mean Temp of the active period
  filter( X3.Active == TRUE) %>% 
  select( sd_temp))
...
(min_Temp_X3_21_22 <- mean_Temp_stats_X3_21_22 %>%  # extract the min Temp of the active period
    select(min_temp)) 
(sd_Temp_X3_21_22 <- mean_Temp_stats_X3_21_22 %>%  # extract the min Temp of the active period
    select(sd_temp))
...
(sd_Temp_active_X3_21_22 <- mean_Temp_active_stats_X3_21_22 %>%  # extract the mean Temp of the active period
  filter( X3.Active == TRUE) %>% 
  select(sd_temp))
...
(min_Temp_X3_22_23 <- mean_Temp_stats_X3_22_23 %>%  # extract the min Temp of the active period
    select(min_temp))
(sd_Temp_X3_22_23 <- mean_Temp_stats_X3_22_23 %>%  # extract the min Temp of the active period
    select(sd_temp))
...
(sd_Temp_active_X3_22_23 <- mean_Temp_active_stats_X3_22_23 %>%  # extract the mean Temp of the active period
  filter( X3.Active == TRUE) %>% 
  select( sd_temp))
```
...
(mean_PAR_active_X3_data <- bind_rows(  # Make into a single dataset
  ...
  summarise( n = n(),
    ...
    max_PAR = max(X3.PAR),
    min_PAR = min(X3.PAR),
    sd_PAR = sd(X3.PAR)))  # calculate the mean PAR of the active period

mean_PAR_active_X3 <- mean_PAR_active_X3_data %>% 
  filter(X3.Active == TRUE) %>% 
  select(mean_PAR)

max_PAR_active_X3 <- mean_PAR_active_X3_data %>% 
  filter(X3.Active == TRUE) %>% 
  select(max_PAR)

min_PAR_active_X3 <- mean_PAR_active_X3_data %>% 
  filter(X3.Active == TRUE) %>% 
  select(min_PAR)

sd_PAR_active_X3 <- mean_PAR_active_X3_data %>% 
  filter(X3.Active == TRUE) %>% 
  select(sd_PAR)
...
(sd_PAR_active_X3_19_20 <- mean_PAR_stats_X3_19_20 %>%  # extract the mean Temp of the active period
  filter( X3.Active == TRUE) %>% 
  select( sd_PAR))
...
(sd_PAR_active_X3_20_21 <- mean_PAR_stats_X3_20_21 %>%  # extract the mean Temp of the active period
  filter( X3.Active == TRUE) %>% 
  select(sd_PAR))
...
(sd_PAR_active_X3_21_22 <- mean_PAR_stats_X3_21_22 %>%  # extract the mean Temp of the active period
  filter( X3.Active == TRUE) %>% 
  select( sd_PAR))
...
(sd_PAR_active_X3_22_23 <- mean_PAR_stats_X3_22_23 %>%  # extract the mean Temp of the active period
  filter( X3.Active == TRUE) %>% 
  select(sd_PAR))
```
...
(mean_yield_active_X3_data <- bind_rows(  # Make into a single dataset
  ...
  summarise( n = n(),
    ...
    sd_Y = sd(X3.chosen_yield)))  # calculate the mean yield of the active period

mean_Y_active_X3 <- mean_yield_active_X3_data %>% 
  filter(X3.Active == TRUE) %>% 
  select(mean_Y)

max_Y_active_X3 <- mean_yield_active_X3_data %>% 
  filter(X3.Active == TRUE) %>% 
  select(max_Y)

min_Y_active_X3 <- mean_yield_active_X3_data %>% 
  filter(X3.Active == TRUE) %>% 
  select(min_Y)

sd_Y_active_X3 <- mean_yield_active_X3_data %>% 
  filter(X3.Active == TRUE) %>% 
  select(sd_Y)
...
(mean_ETR_active_X3_data <- bind_rows(  # Make into a single dataset
  ...
  summarise( n = n(),
    ...
    sd_ETR = sd(X3.chosen_ETR)))  # calculate the mean ETR of the active period

mean_ETR_active_X3 <- mean_ETR_active_X3_data %>% 
  filter(X3.Active == TRUE) %>% 
  select(mean_ETR)

max_ETR_active_X3 <- mean_ETR_active_X3_data %>% 
  filter(X3.Active == TRUE) %>% 
  select(max_ETR)

min_ETR_active_X3 <- mean_ETR_active_X3_data %>% 
  filter(X3.Active == TRUE) %>% 
  select(min_ETR)

sd_ETR_active_X3 <- mean_ETR_active_X3_data %>% 
  filter(X3.Active == TRUE) %>% 
  select(sd_ETR)
```
...
(sd_Y_active_X3_19_20 <- mean_yield_stats_X3_19_20 %>%  # extract the max yield of the active period
  filter( X3.Active == TRUE) %>% 
  select( sd_Y))
...
(sd_ETR_active_X3_19_20 <- mean_ETR_stats_X3_19_20 %>%  # extract the mean ETR of the active period
  filter( X3.Active == TRUE) %>% 
  select( sd_ETR))
...
(sd_Y_active_X3_20_21 <- mean_yield_stats_X3_20_21 %>%  # extract the max yield of the active period
  filter( X3.Active == TRUE) %>% 
  select( sd_Y))
...
(sd_ETR_active_X3_20_21 <- mean_ETR_stats_X3_20_21 %>%  # extract the mean ETR of the active period
  filter( X3.Active == TRUE) %>% 
  select( sd_ETR))
...
(sd_Y_active_X3_21_22 <- mean_yield_stats_X3_21_22 %>%  # extract the max yield of the active period
  filter( X3.Active == TRUE) %>% 
  select( sd_Y))
...
(sd_ETR_active_X3_21_22 <- mean_ETR_stats_X3_21_22 %>%  # extract the mean ETR of the active period
  filter( X3.Active == TRUE) %>% 
  select( sd_ETR))
...
(sd_Y_active_X3_22_23 <- mean_yield_stats_X3_22_23 %>%  # extract the max yield of the active period
  filter( X3.Active == TRUE) %>% 
  select( sd_Y))
...
(sd_ETR_active_X3_22_23 <- mean_ETR_stats_X3_22_23 %>%  # extract the mean ETR of the active period
  filter( X3.Active == TRUE) %>% 
  select( sd_ETR))
...
```{r}
(month_Y_stats_X3_2 <- bind_rows(  # Monthly stats fro total measuring period
  summer_20_21 %>% filter(Month == 11),
  summer_20_21 %>% filter(Month == 12),
  summer_20_21 %>% filter(Month == 1),
  summer_20_21 %>% filter(Month == 2),
  ...
  summer_22_23 %>% filter(Month == 2)) %>% 
   group_by(Year, Month) %>% 
 summarise(mean_Y= mean(X3.chosen_yield),
            max_Y = max(X3.chosen_yield),  # get the maximum temperature
            min_Y = min(X3.chosen_yield),
            sd_Y = sd(X3.chosen_yield)))

(month_Y_stats_X3_1 <- bind_rows(  # Monthly stats fro total measuring period
  summer_19_20 %>% filter(Month == 11),
  summer_19_20 %>% filter(Month == 12),
  summer_19_20 %>% filter(Month == 1),
  summer_19_20 %>% filter(Month == 2),
...
summarise(mean_Y= mean(X3.Y),
            ...
            min_Y = min(X3.Y),
            sd_Y = sd(X3.Y)))
month_Y_stats_X3 <- bind_rows(month_Y_stats_X3_1, month_Y_stats_X3_2)

write.xlsx(month_Y_stats_X3, file = "stats/austroplaca/month_Y_stats_X3.xlsx") # save table

(month_ETR_stats_X3_2 <- bind_rows(  # Monthly stats fro total measuring period
  summer_20_21 %>% filter(Month == 11),
  summer_20_21 %>% filter(Month == 12),
  summer_20_21 %>% filter(Month == 1),
  summer_20_21 %>% filter(Month == 2),
  ...
  summer_22_23 %>% filter(Month == 2)) %>% 
   group_by(Year, Month) %>% 
 summarise(mean_ETR= mean(X3.chosen_ETR),
            max_ETR = max(X3.chosen_ETR),  # get the maximum temperature
            min_ETR = min(X3.chosen_ETR),
            sd_ETR = sd(X3.chosen_ETR)))

(month_ETR_stats_X3_1 <- bind_rows(  # Monthly stats fro total measuring period
  summer_19_20 %>% filter(Month == 11),
  summer_19_20 %>% filter(Month == 12),
  summer_19_20 %>% filter(Month == 1),
  summer_19_20 %>% filter(Month == 2),
...
month_ETR_stats_X3 <- bind_rows(month_ETR_stats_X3_1, month_ETR_stats_X3_2)
...
(Percentage_active_hours_X1 <- total_active_hours_X1/(nrow(data_clean) + nrow(data_clean_23)) * 100) # calculate the percentage 
```
...
(mean_Temp_X1_data <- bind_rows(
  ...
  summarise(mean_temp = mean(X1.Temp),
            ...
            sd_temp = sd(X1.Temp)))  # get the minimum temperature

mean_Temp_X1 <- mean_Temp_X1_data %>% 
  select( mean_temp)

max_Temp_X1 <- mean_Temp_X1_data %>% 
  select( max_temp)

min_Temp_X1 <- mean_Temp_X1_data %>% 
  select( min_temp)

sd_Temp_X1 <- mean_Temp_X1_data %>% 
  select( sd_temp)
...
(mean_Temp_active_X1_data <- bind_rows(  # Make into a single dataset
  ...
  summarise( n = n(),
    ...
    min_temp = min(X1.Temp),
    sd_temp = sd(X1.Temp)))  # calculate the mean Temp of the active period

(mean_Temp_active_X1 <- mean_Temp_active_X1_data %>%  # extract the mean Temp of the active period
  filter( X1.Active == TRUE) %>% 
  select( mean_temp))

(max_Temp_active_X1 <- mean_Temp_active_X1_data %>%  # extract the mean Temp of the active period
  filter( X1.Active == TRUE) %>% 
  select( max_temp))

(min_Temp_active_X1 <- mean_Temp_active_X1_data %>%  # extract the mean Temp of the active period
  filter( X1.Active == TRUE) %>% 
  select( min_temp))

(sd_Temp_active_X1 <- mean_Temp_active_X1_data %>%  # extract the mean Temp of the active period
  filter( X1.Active == TRUE) %>% 
  select( sd_temp))
```
...
(min_Temp_X1_19_20 <- mean_Temp_stats_X1_19_20 %>%  # extract the min Temp of the active period
    select(min_temp)) 
(sd_Temp_X1_19_20 <- mean_Temp_stats_X1_19_20 %>%  # extract the min Temp of the active period
    select(sd_temp))
...
(sd_Temp_active_X1_19_20 <- mean_Temp_active_stats_X1_19_20 %>%  # extract the mean Temp of the active period
  filter( X1.Active == TRUE) %>% 
  select( sd_temp))
...
(min_Temp_X1_20_21 <- mean_Temp_stats_X1_20_21 %>%  # extract the min Temp of the active period
    select(min_temp)) 
(sd_Temp_X1_20_21 <- mean_Temp_stats_X1_20_21 %>%  # extract the min Temp of the active period
    select(sd_temp)) 
...
(sd_Temp_active_X1_20_21 <- mean_Temp_active_stats_X1_20_21 %>%  # extract the mean Temp of the active period
  filter( X1.Active == TRUE) %>% 
  select( sd_temp))
...
(min_Temp_X1_21_22 <- mean_Temp_stats_X1_21_22 %>%  # extract the min Temp of the active period
    select(min_temp)) 
(sd_Temp_X1_21_22 <- mean_Temp_stats_X1_21_22 %>%  # extract the min Temp of the active period
    select(sd_temp))
...
(sd_Temp_active_X1_21_22 <- mean_Temp_active_stats_X1_21_22 %>%  # extract the mean Temp of the active period
  filter( X1.Active == TRUE) %>% 
  select(sd_temp))
...
(min_Temp_X1_22_23 <- mean_Temp_stats_X1_22_23 %>%  # extract the min Temp of the active period
    select(min_temp))
(sd_Temp_X1_22_23 <- mean_Temp_stats_X1_22_23 %>%  # extract the min Temp of the active period
    select(sd_temp))
...
(sd_Temp_active_X1_22_23 <- mean_Temp_active_stats_X1_22_23 %>%  # extract the mean Temp of the active period
  filter( X1.Active == TRUE) %>% 
  select( sd_temp))
```
...
(mean_PAR_active_X1_data <- bind_rows(  # Make into a single dataset
  ...
  summarise( n = n(),
    ...
    max_PAR = max(X1.PAR),
    min_PAR = min(X1.PAR),
    sd_PAR = sd(X1.PAR)))  # calculate the mean PAR of the active period

mean_PAR_active_X1 <- mean_PAR_active_X1_data %>% 
  filter(X1.Active == TRUE) %>% 
  select(mean_PAR)

max_PAR_active_X1 <- mean_PAR_active_X1_data %>% 
  filter(X1.Active == TRUE) %>% 
  select(max_PAR)

min_PAR_active_X1 <- mean_PAR_active_X1_data %>% 
  filter(X1.Active == TRUE) %>% 
  select(min_PAR)

sd_PAR_active_X1 <- mean_PAR_active_X1_data %>% 
  filter(X1.Active == TRUE) %>% 
  select(sd_PAR)
```
...
(sd_PAR_active_X1_19_20 <- mean_PAR_stats_X1_19_20 %>%  # extract the mean Temp of the active period
  filter( X1.Active == TRUE) %>% 
  select( sd_PAR))
...
(sd_PAR_active_X1_20_21 <- mean_PAR_stats_X1_20_21 %>%  # extract the mean Temp of the active period
  filter( X1.Active == TRUE) %>% 
  select(sd_PAR))
...
(sd_PAR_active_X1_21_22 <- mean_PAR_stats_X1_21_22 %>%  # extract the mean Temp of the active period
  filter( X1.Active == TRUE) %>% 
  select( sd_PAR))
...
(sd_PAR_active_X1_22_23 <- mean_PAR_stats_X1_22_23 %>%  # extract the mean Temp of the active period
  filter( X1.Active == TRUE) %>% 
  select(sd_PAR))
```
...
(mean_yield_active_X1_data <- bind_rows(  # Make into a single dataset
  ...
  summarise( n = n(),
    ...
    max_Y = max(X1.Y),
    min_Y = min(X1.Y),
    sd_Y = sd(X1.Y)))  # calculate the mean yield of the active period

mean_Y_active_X1 <- mean_yield_active_X1_data %>% 
  filter(X1.Active == TRUE) %>% 
  select(mean_Y)

max_Y_active_X1 <- mean_yield_active_X1_data %>% 
  filter(X1.Active == TRUE) %>% 
  select(max_Y)

min_Y_active_X1 <- mean_yield_active_X1_data %>% 
  filter(X1.Active == TRUE) %>% 
  select(min_Y)

sd_Y_active_X1 <- mean_yield_active_X1_data %>% 
  filter(X1.Active == TRUE) %>% 
  select(sd_Y)
...
(mean_ETR_active_X1_data <- bind_rows(  # Make into a single dataset
  ...
  summarise( n = n(),
    ...
    max_ETR = max(X1.ETR),
    min_ETR = min(X1.ETR),
    sd_ETR = sd(X1.ETR)))  # calculate the mean ETR of the active period

mean_ETR_active_X1 <- mean_ETR_active_X1_data %>% 
  filter(X1.Active == TRUE) %>% 
  select(mean_ETR)

max_ETR_active_X1 <- mean_ETR_active_X1_data %>% 
  filter(X1.Active == TRUE) %>% 
  select(max_ETR)

min_ETR_active_X1 <- mean_ETR_active_X1_data %>% 
  filter(X1.Active == TRUE) %>% 
  select(min_ETR)

sd_ETR_active_X1 <- mean_ETR_active_X1_data %>% 
  filter(X1.Active == TRUE) %>% 
  select(sd_ETR)
```
...
(sd_Y_active_X1_19_20 <- mean_yield_stats_X1_19_20 %>%  # extract the max yield of the active period
  filter( X1.Active == TRUE) %>% 
  select( sd_Y))
...
(sd_ETR_active_X1_19_20 <- mean_ETR_stats_X1_19_20 %>%  # extract the mean ETR of the active period
  filter( X1.Active == TRUE) %>% 
  select( sd_ETR))
...
(sd_Y_active_X1_20_21 <- mean_yield_stats_X1_20_21 %>%  # extract the max yield of the active period
  filter( X1.Active == TRUE) %>% 
  select( sd_Y))
...
(sd_ETR_active_X1_20_21 <- mean_ETR_stats_X1_20_21 %>%  # extract the mean ETR of the active period
  filter( X1.Active == TRUE) %>% 
  select( sd_ETR))
...
(sd_Y_active_X1_21_22 <- mean_yield_stats_X1_21_22 %>%  # extract the max yield of the active period
  filter( X1.Active == TRUE) %>% 
  select( sd_Y))
...
(sd_ETR_active_X1_21_22 <- mean_ETR_stats_X1_21_22 %>%  # extract the mean ETR of the active period
  filter( X1.Active == TRUE) %>% 
  select( sd_ETR))
...
(sd_Y_active_X1_22_23 <- mean_yield_stats_X1_22_23 %>%  # extract the max yield of the active period
  filter( X1.Active == TRUE) %>% 
  select( sd_Y))
...
(sd_ETR_active_X1_22_23 <- mean_ETR_stats_X1_22_23 %>%  # extract the mean ETR of the active period
  filter( X1.Active == TRUE) %>% 
  select( sd_ETR))
```
...
(Percentage_active_hours_X2 <- total_active_hours_X2/(nrow(data_clean) + nrow(data_clean_23)) * 100) # calculate the percentage 
```
...
(mean_Temp_X2_data <- bind_rows(
  ...
  summarise(mean_temp = mean(X2.Temp),
            ...
            sd_temp = sd(X2.Temp)))  # get the minimum temperature

mean_Temp_X2 <- mean_Temp_X2_data %>% 
  select( mean_temp)

max_Temp_X2 <- mean_Temp_X2_data %>% 
  select( max_temp)

min_Temp_X2 <- mean_Temp_X2_data %>% 
  select( min_temp)

sd_Temp_X2 <- mean_Temp_X2_data %>% 
  select( sd_temp)
...
(mean_Temp_active_X2_data <- bind_rows(  # Make into a single dataset
  ...
  summarise( n = n(),
    ...
    min_temp = min(X2.Temp),
    sd_temp = sd(X2.Temp)))  # calculate the mean Temp of the active period

(mean_Temp_active_X2 <- mean_Temp_active_X2_data %>%  # extract the mean Temp of the active period
  filter( X2.Active == TRUE) %>% 
  select( mean_temp))

(max_Temp_active_X2 <- mean_Temp_active_X2_data %>%  # extract the mean Temp of the active period
  filter( X2.Active == TRUE) %>% 
  select( max_temp))

(min_Temp_active_X2 <- mean_Temp_active_X2_data %>%  # extract the mean Temp of the active period
  filter( X2.Active == TRUE) %>% 
  select( min_temp))

(sd_Temp_active_X2 <- mean_Temp_active_X2_data %>%  # extract the mean Temp of the active period
  filter( X2.Active == TRUE) %>% 
  select( sd_temp))
```
...
(min_Temp_X2_19_20 <- mean_Temp_stats_X2_19_20 %>%  # extract the min Temp of the active period
    select(min_temp)) 
(sd_Temp_X2_19_20 <- mean_Temp_stats_X2_19_20 %>%  # extract the min Temp of the active period
    select(sd_temp))
...
(sd_Temp_active_X2_19_20 <- mean_Temp_active_stats_X2_19_20 %>%  # extract the mean Temp of the active period
  filter( X2.Active == TRUE) %>% 
  select( sd_temp))
...
(min_Temp_X2_20_21 <- mean_Temp_stats_X2_20_21 %>%  # extract the min Temp of the active period
    select(min_temp)) 
(sd_Temp_X2_20_21 <- mean_Temp_stats_X2_20_21 %>%  # extract the min Temp of the active period
    select(sd_temp)) 
...
(sd_Temp_active_X2_20_21 <- mean_Temp_active_stats_X2_20_21 %>%  # extract the mean Temp of the active period
  filter( X2.Active == TRUE) %>% 
  select( sd_temp))
...
(min_Temp_X2_21_22 <- mean_Temp_stats_X2_21_22 %>%  # extract the min Temp of the active period
    select(min_temp)) 
(sd_Temp_X2_21_22 <- mean_Temp_stats_X2_21_22 %>%  # extract the min Temp of the active period
    select(sd_temp))
...
(sd_Temp_active_X2_21_22 <- mean_Temp_active_stats_X2_21_22 %>%  # extract the mean Temp of the active period
  filter( X2.Active == TRUE) %>% 
  select(sd_temp))
...
(min_Temp_X2_22_23 <- mean_Temp_stats_X2_22_23 %>%  # extract the min Temp of the active period
    select(min_temp))
(sd_Temp_X2_22_23 <- mean_Temp_stats_X2_22_23 %>%  # extract the min Temp of the active period
    select(sd_temp))
...
(sd_Temp_active_X2_22_23 <- mean_Temp_active_stats_X2_22_23 %>%  # extract the mean Temp of the active period
  filter( X2.Active == TRUE) %>% 
  select( sd_temp))
```
...
(mean_PAR_active_X2_data <- bind_rows(  # Make into a single dataset
  ...
  summarise( n = n(),
    ...
    max_PAR = max(X2.PAR),
    min_PAR = min(X2.PAR),
    sd_PAR = sd(X2.PAR)))  # calculate the mean PAR of the active period

mean_PAR_active_X2 <- mean_PAR_active_X2_data %>% 
  filter(X2.Active == TRUE) %>% 
  select(mean_PAR)

max_PAR_active_X2 <- mean_PAR_active_X2_data %>% 
  filter(X2.Active == TRUE) %>% 
  select(max_PAR)

min_PAR_active_X2 <- mean_PAR_active_X2_data %>% 
  filter(X2.Active == TRUE) %>% 
  select(min_PAR)

sd_PAR_active_X2 <- mean_PAR_active_X2_data %>% 
  filter(X2.Active == TRUE) %>% 
  select(sd_PAR)
...
(sd_PAR_active_X2_19_20 <- mean_PAR_stats_X2_19_20 %>%  # extract the mean Temp of the active period
  filter( X2.Active == TRUE) %>% 
  select( sd_PAR))
...
(sd_PAR_active_X2_20_21 <- mean_PAR_stats_X2_20_21 %>%  # extract the mean Temp of the active period
  filter( X2.Active == TRUE) %>% 
  select(sd_PAR))
...
(sd_PAR_active_X2_21_22 <- mean_PAR_stats_X2_21_22 %>%  # extract the mean Temp of the active period
  filter( X2.Active == TRUE) %>% 
  select( sd_PAR))
...
(sd_PAR_active_X2_22_23 <- mean_PAR_stats_X2_22_23 %>%  # extract the mean Temp of the active period
  filter( X2.Active == TRUE) %>% 
  select(sd_PAR))
...
(mean_yield_active_X2_data <- bind_rows(  # Make into a single dataset
  ...
  summarise( n = n(),
    ...
    max_Y = max(X2.Y),
    min_Y = min(X2.Y),
    sd_Y = sd(X2.Y)))  # calculate the mean yield of the active period

mean_Y_active_X2 <- mean_yield_active_X2_data %>% 
  filter(X2.Active == TRUE) %>% 
  select(mean_Y)

max_Y_active_X2 <- mean_yield_active_X2_data %>% 
  filter(X2.Active == TRUE) %>% 
  select(max_Y)

min_Y_active_X2 <- mean_yield_active_X2_data %>% 
  filter(X2.Active == TRUE) %>% 
  select(min_Y)

sd_Y_active_X2 <- mean_yield_active_X2_data %>% 
  filter(X2.Active == TRUE) %>% 
  select(sd_Y)
...
(mean_ETR_active_X2_data <- bind_rows(  # Make into a single dataset
  ...
  summarise( n = n(),
    ...
    max_ETR = max(X2.ETR),
    min_ETR = min(X2.ETR),
    sd_ETR = sd(X2.ETR)))  # calculate the mean ETR of the active period

mean_ETR_active_X2 <- mean_ETR_active_X2_data %>% 
  filter(X2.Active == TRUE) %>% 
  select(mean_ETR)

max_ETR_active_X2 <- mean_ETR_active_X2_data %>% 
  filter(X2.Active == TRUE) %>% 
  select(max_ETR)

min_ETR_active_X2 <- mean_ETR_active_X2_data %>% 
  filter(X2.Active == TRUE) %>% 
  select(min_ETR)

sd_ETR_active_X2 <- mean_ETR_active_X2_data %>% 
  filter(X2.Active == TRUE) %>% 
  select(sd_ETR)
...
(sd_Y_active_X2_19_20 <- mean_yield_stats_X2_19_20 %>%  # extract the max yield of the active period
  filter( X2.Active == TRUE) %>% 
  select( sd_Y))
...
(sd_ETR_active_X2_19_20 <- mean_ETR_stats_X2_19_20 %>%  # extract the mean ETR of the active period
  filter( X2.Active == TRUE) %>% 
  select( sd_ETR))
...
(sd_Y_active_X2_20_21 <- mean_yield_stats_X2_20_21 %>%  # extract the max yield of the active period
  filter( X2.Active == TRUE) %>% 
  select( sd_Y))
...
(sd_ETR_active_X2_20_21 <- mean_ETR_stats_X2_20_21 %>%  # extract the mean ETR of the active period
  filter( X2.Active == TRUE) %>% 
  select( sd_ETR))
...
(sd_Y_active_X2_21_22 <- mean_yield_stats_X2_21_22 %>%  # extract the max yield of the active period
  filter( X2.Active == TRUE) %>% 
  select( sd_Y))
...
(sd_ETR_active_X2_21_22 <- mean_ETR_stats_X2_21_22 %>%  # extract the mean ETR of the active period
  filter( X2.Active == TRUE) %>% 
  select( sd_ETR))
...
(sd_Y_active_X2_22_23 <- mean_yield_stats_X2_22_23 %>%  # extract the max yield of the active period
  filter( X2.Active == TRUE) %>% 
  select( sd_Y))
...
(sd_ETR_active_X2_22_23 <- mean_ETR_stats_X2_22_23 %>%  # extract the mean ETR of the active period
  filter( X2.Active == TRUE) %>% 
  select( sd_ETR))
...
(Percentage_active_hours_X4 <- total_active_hours_X4/(nrow(data_clean) + nrow(data_clean_23)) * 100) # calculate the percentage 
```
...
(mean_Temp_X4_data <- bind_rows(
  ...
  summarise(mean_temp = mean(X4.Temp),
            ...
            sd_temp = sd(X4.Temp)))  # get the minimum temperature

mean_Temp_X4 <- mean_Temp_X4_data %>% 
  select( mean_temp)

max_Temp_X4 <- mean_Temp_X4_data %>% 
  select( max_temp)

min_Temp_X4 <- mean_Temp_X4_data %>% 
  select( min_temp)

sd_Temp_X4 <- mean_Temp_X4_data %>% 
  select( sd_temp)
...
(mean_Temp_active_X4_data <- bind_rows(  # Make into a single dataset
  ...
  summarise( n = n(),
    ...
    min_temp = min(X4.Temp),
    sd_temp = sd(X4.Temp)))  # calculate the mean Temp of the active period
...
(max_Temp_active_X4 <- mean_Temp_active_X4_data %>%  # extract the mean Temp of the active period
  filter( X4.Active == TRUE) %>% 
  select( max_temp))

(min_Temp_active_X4 <- mean_Temp_active_X4_data %>%  # extract the mean Temp of the active period
  filter( X4.Active == TRUE) %>% 
  select( min_temp))

(sd_Temp_active_X4 <- mean_Temp_active_X4_data %>%  # extract the mean Temp of the active period
  filter( X4.Active == TRUE) %>% 
  select( sd_temp))
```
...
(min_Temp_X4_19_20 <- mean_Temp_stats_X4_19_20 %>%  # extract the min Temp of the active period
    select(min_temp)) 
(sd_Temp_X4_19_20 <- mean_Temp_stats_X4_19_20 %>%  # extract the min Temp of the active period
    select(sd_temp))
...
(sd_Temp_active_X4_19_20 <- mean_Temp_active_stats_X4_19_20 %>%  # extract the mean Temp of the active period
  filter( X4.Active == TRUE) %>% 
  select( sd_temp))
...
(min_Temp_X4_20_21 <- mean_Temp_stats_X4_20_21 %>%  # extract the min Temp of the active period
    select(min_temp)) 
(sd_Temp_X4_20_21 <- mean_Temp_stats_X4_20_21 %>%  # extract the min Temp of the active period
    select(sd_temp)) 
...
(sd_Temp_active_X4_20_21 <- mean_Temp_active_stats_X4_20_21 %>%  # extract the mean Temp of the active period
  filter( X4.Active == TRUE) %>% 
  select( sd_temp))
...
(min_Temp_X4_21_22 <- mean_Temp_stats_X4_21_22 %>%  # extract the min Temp of the active period
    select(min_temp)) 
(sd_Temp_X4_21_22 <- mean_Temp_stats_X4_21_22 %>%  # extract the min Temp of the active period
    select(sd_temp))
...
(sd_Temp_active_X4_21_22 <- mean_Temp_active_stats_X4_21_22 %>%  # extract the mean Temp of the active period
  filter( X4.Active == TRUE) %>% 
  select(sd_temp))
...
(min_Temp_X4_22_23 <- mean_Temp_stats_X4_22_23 %>%  # extract the min Temp of the active period
    select(min_temp))
(sd_Temp_X4_22_23 <- mean_Temp_stats_X4_22_23 %>%  # extract the min Temp of the active period
    select(sd_temp))
...
(sd_Temp_active_X4_22_23 <- mean_Temp_active_stats_X4_22_23 %>%  # extract the mean Temp of the active period
  filter( X4.Active == TRUE) %>% 
  select( sd_temp))
...
(mean_PAR_active_X4_data <- bind_rows(  # Make into a single dataset
  ...
  summarise( n = n(),
    ...
    max_PAR = max(X4.PAR),
    min_PAR = min(X4.PAR),
    sd_PAR = sd(X4.PAR)))  # calculate the mean PAR of the active period

mean_PAR_active_X4 <- mean_PAR_active_X4_data %>% 
  filter(X4.Active == TRUE) %>% 
  select(mean_PAR)

max_PAR_active_X4 <- mean_PAR_active_X4_data %>% 
  filter(X4.Active == TRUE) %>% 
  select(max_PAR)

min_PAR_active_X4 <- mean_PAR_active_X4_data %>% 
  filter(X4.Active == TRUE) %>% 
  select(min_PAR)

sd_PAR_active_X4 <- mean_PAR_active_X4_data %>% 
  filter(X4.Active == TRUE) %>% 
  select(sd_PAR)
```
...
(sd_PAR_active_X4_19_20 <- mean_PAR_stats_X4_19_20 %>%  # extract the mean Temp of the active period
  filter( X4.Active == TRUE) %>% 
  select( sd_PAR))
...
(sd_PAR_active_X4_20_21 <- mean_PAR_stats_X4_20_21 %>%  # extract the mean Temp of the active period
  filter( X4.Active == TRUE) %>% 
  select(sd_PAR))
...
(sd_PAR_active_X4_21_22 <- mean_PAR_stats_X4_21_22 %>%  # extract the mean Temp of the active period
  filter( X4.Active == TRUE) %>% 
  select( sd_PAR))
...
(sd_PAR_active_X4_22_23 <- mean_PAR_stats_X4_22_23 %>%  # extract the mean Temp of the active period
  filter( X4.Active == TRUE) %>% 
  select(sd_PAR))
...
(mean_yield_active_X4_data <- bind_rows(  # Make into a single dataset
  ...
  summarise( n = n(),
    ...
    max_Y = max(X4.Y),
    min_Y = min(X4.Y),
    sd_Y = sd(X4.Y)))  # calculate the mean yield of the active period

mean_Y_active_X4 <- mean_yield_active_X4_data %>% 
  filter(X4.Active == TRUE) %>% 
  select(mean_Y)

max_Y_active_X4 <- mean_yield_active_X4_data %>% 
  filter(X4.Active == TRUE) %>% 
  select(max_Y)

min_Y_active_X4 <- mean_yield_active_X4_data %>% 
  filter(X4.Active == TRUE) %>% 
  select(min_Y)

sd_Y_active_X4 <- mean_yield_active_X4_data %>% 
  filter(X4.Active == TRUE) %>% 
  select(sd_Y)
...
(mean_ETR_active_X4_data <- bind_rows(  # Make into a single dataset
  ...
  summarise( n = n(),
    ...
    max_ETR = max(X4.ETR),
    min_ETR = min(X4.ETR),
    sd_ETR = sd(X4.ETR)))  # calculate the mean ETR of the active period

mean_ETR_active_X4 <- mean_ETR_active_X4_data %>% 
  filter(X4.Active == TRUE) %>% 
  select(mean_ETR)

max_ETR_active_X4 <- mean_ETR_active_X4_data %>% 
  filter(X4.Active == TRUE) %>% 
  select(max_ETR)

min_ETR_active_X4 <- mean_ETR_active_X4_data %>% 
  filter(X4.Active == TRUE) %>% 
  select(min_ETR)

sd_ETR_active_X4 <- mean_ETR_active_X4_data %>% 
  filter(X4.Active == TRUE) %>% 
  select(sd_ETR)
```
...
(sd_Y_active_X4_19_20 <- mean_yield_stats_X4_19_20 %>%  # extract the max yield of the active period
  filter( X4.Active == TRUE) %>% 
  select( sd_Y))
...
(sd_ETR_active_X4_19_20 <- mean_ETR_stats_X4_19_20 %>%  # extract the mean ETR of the active period
  filter( X4.Active == TRUE) %>% 
  select( sd_ETR))
...
(sd_Y_active_X4_20_21 <- mean_yield_stats_X4_20_21 %>%  # extract the max yield of the active period
  filter( X4.Active == TRUE) %>% 
  select( sd_Y))
...
(sd_ETR_active_X4_20_21 <- mean_ETR_stats_X4_20_21 %>%  # extract the mean ETR of the active period
  filter( X4.Active == TRUE) %>% 
  select( sd_ETR))
...
(sd_Y_active_X4_21_22 <- mean_yield_stats_X4_21_22 %>%  # extract the max yield of the active period
  filter( X4.Active == TRUE) %>% 
  select( sd_Y))
...
(sd_ETR_active_X4_21_22 <- mean_ETR_stats_X4_21_22 %>%  # extract the mean ETR of the active period
  filter( X4.Active == TRUE) %>% 
  select( sd_ETR))
...
(sd_Y_active_X4_22_23 <- mean_yield_stats_X4_22_23 %>%  # extract the max yield of the active period
  filter( X4.Active == TRUE) %>% 
  select( sd_Y))
...
(sd_ETR_active_X4_22_23 <- mean_ETR_stats_X4_22_23 %>%  # extract the mean ETR of the active period
  filter( X4.Active == TRUE) %>% 
  select( sd_ETR))
...
```{r}
(list_act_time <- list(total_activetime_stats_X2,total_activetime_stats_X2, total_activetime_stats_X4)) # put all datasets in a list
...
(Percentage_active_hours_moss <- total_active_hours_moss/(nrow(data_clean) + nrow(data_clean_23)) * 100)
```
...
```{r}
(list_act_time_month <- list(month_activetime_stats_X1, month_activetime_stats_X2, month_activetime_stats_X4)) # put all datasets in a list
# (summer_activetime_stats_moss <- Reduce(`+`, list_act_time_month)/length(list_act_time_month)) # average them 
# Can't do it because they are not active the same amount of time
```
...
mean_Temp_moss <- mean_Temp_moss_data %>% 
  select( mean_temp)

max_Temp_moss <- mean_Temp_moss_data %>% 
  select( max_temp)

min_Temp_moss <- mean_Temp_moss_data %>% 
  select( min_temp)
...
mean_Temp_active_moss <- mean_Temp_active_moss_data %>% 
  filter(X1.Active == TRUE) %>% 
  select( mean_temp)

max_Temp_active_moss <- mean_Temp_active_moss_data %>% 
  filter(X1.Active == TRUE) %>% 
  select( max_temp)

min_Temp_active_moss <- mean_Temp_active_moss_data %>% 
  filter(X1.Active == TRUE) %>% 
  select( min_temp)
```
...
mean_PAR_active_moss <- mean_measuring_PAR_moss %>% 
  filter(X1.Active == TRUE) %>% 
  select(mean_PAR)

max_PAR_active_moss <- mean_measuring_PAR_moss %>% 
  filter(X1.Active == TRUE) %>% 
  select(max_PAR)

min_PAR_active_moss <- mean_measuring_PAR_moss %>% 
  filter(X1.Active == TRUE) %>% 
  select(min_PAR)
```
...
mean_Y_active_moss <- mean_measuring_active_yield_moss %>% 
  filter(X1.Active == TRUE) %>% 
  select( mean_Y )

max_Y_active_moss <- mean_measuring_active_yield_moss %>% 
  filter(X1.Active == TRUE) %>% 
  select( max_Y )

min_Y_active_moss <- mean_measuring_active_yield_moss %>% 
    filter(X1.Active == TRUE) %>% 
  select( min_Y )
...
(mean_measuring_active_ETR_moss <- Reduce(`+`, list_measuring_active_ETR_moss)/length(list_measuring_active_ETR_moss)) # average them 

mean_ETR_active_moss <- mean_measuring_active_ETR_moss %>% 
    filter(X1.Active == TRUE) %>% 
  select( mean_ETR )

max_ETR_active_moss <- mean_measuring_active_ETR_moss %>% 
    filter(X1.Active == TRUE) %>% 
  select( max_ETR )

min_ETR_active_Temp_moss <- mean_measuring_active_ETR_moss %>% 
    filter(X1.Active == TRUE) %>% 
  select( min_ETR )
```
...
## 10.1 Create table for general values to compare

```{r}

# create table for general values to compare

(table_general <- data.frame(
  Category = c(
    "Total active hours", "% active hours", "Average TT", "Sd TT", "Min TT",
    "Max TT", "Average TT active", "Sd TT active","Min TT active",
    "Max TT active", "Mean PAR","Sd. PAR", "Max Par", "MAX Yield", "Mean Yield", "Sd. Yield", 
    " Mean ETR", "St. Dev. ETR ","Max ETR", "Mean air T", "Sd. air T" ,"min air T", "max air T", 
    "mean RH (%)", "Sd. RH"
  ),
  Austroplaca_X3 = c(
    pull(total_active_hours_X3), pull(Percentage_active_hours_X3), 
    pull(mean_Temp_X3), pull(sd_Temp_X3),pull(min_Temp_X3), pull(max_Temp_X3),
    pull(mean_Temp_active_X3), pull(sd_Temp_active_X3),pull(min_Temp_active_X3),
    pull(max_Temp_active_X3), pull(mean_PAR_active_X3),pull(sd_PAR_active_X3),
    pull(max_PAR_active_X3), pull(max_Y_active_X3),
    pull(mean_Y_active_X3), pull(sd_Y_active_X3), pull(mean_ETR_active_X3), pull(sd_ETR_active_X3),
    pull(max_ETR_active_X3), 0, 0, 0, 0,0,0
  ),
  Bryum_X1 = c(
      pull(total_active_hours_X1), pull(Percentage_active_hours_X1), 
    pull(mean_Temp_X1), pull(sd_Temp_X1),pull(min_Temp_X1), pull(max_Temp_X1),
    pull(mean_Temp_active_X1), pull(sd_Temp_active_X1),pull(min_Temp_active_X1),
    pull(max_Temp_active_X1), pull(mean_PAR_active_X1),pull(sd_PAR_active_X1),
    pull(max_PAR_active_X1), pull(max_Y_active_X1),
    pull(mean_Y_active_X1), pull(sd_Y_active_X1), pull(mean_ETR_active_X1), pull(sd_ETR_active_X1),
    pull(max_ETR_active_X1), 0, 0, 0, 0, 0, 0
  ),
  Bryum_X2 = c(
      pull(total_active_hours_X2), pull(Percentage_active_hours_X2), 
    pull(mean_Temp_X2), pull(sd_Temp_X2),pull(min_Temp_X2), pull(max_Temp_X2),
    pull(mean_Temp_active_X2), pull(sd_Temp_active_X2),pull(min_Temp_active_X2),
    pull(max_Temp_active_X2), pull(mean_PAR_active_X2),pull(sd_PAR_active_X2),
    pull(max_PAR_active_X2), pull(max_Y_active_X2),
    pull(mean_Y_active_X2), pull(sd_Y_active_X2), pull(mean_ETR_active_X2), pull(sd_ETR_active_X2),
    pull(max_ETR_active_X2), 0, 0, 0, 0, 0, 0
    ),
 Bryum_X4 = c(
    pull(total_active_hours_X4), pull(Percentage_active_hours_X4), 
    pull(mean_Temp_X4), pull(sd_Temp_X4),pull(min_Temp_X4), pull(max_Temp_X4),
    pull(mean_Temp_active_X4), pull(sd_Temp_active_X4),pull(min_Temp_active_X4),
    pull(max_Temp_active_X4), pull(mean_PAR_active_X4),pull(sd_PAR_active_X4),
    pull(max_PAR_active_X4), pull(max_Y_active_X4),
    pull(mean_Y_active_X4), pull(sd_Y_active_X4), pull(mean_ETR_active_X4), pull(sd_ETR_active_X4),
    pull(max_ETR_active_X4), 0, 0, 0, 0, 0, 0
  ),
  Bryum_average = c(
    pull(total_active_hours_moss), pull(Percentage_active_hours_moss),
    pull(mean_Temp_X4), "-",pull(min_Temp_moss), pull(max_Temp_moss),
    pull(mean_Temp_active_moss),"-", pull(min_Temp_active_moss),
    pull(max_Temp_active_moss), pull(mean_PAR_active_moss),"-",
    pull(max_PAR_active_moss), pull(max_Y_active_moss),
    pull(mean_Y_active_moss),"-", pull(mean_ETR_active_moss),"-",
    pull(max_ETR_active_moss), 0, 0, 0, 0, 0, 0
  )))
 
write.xlsx(table_general, file = "stats/general/table_general.xlsx") # save table
```
 
## 10.2. Create a table with all the values of each summer to compare
...
table_2019_2020 <- data.frame(  
  ...
  Austroplaca_X3 = c(
    pull(total_active_hours_19_20_X3), pull(Percentage_active_hours_19_20_X3), # pull removes the value from the tibble
    pull(mean_Temp_X3_19_20), pull(sd_Temp_X3_19_20), pull(min_Temp_X3_19_20), pull(max_Temp_X3_19_20), 
    pull(mean_Temp_active_X3_19_20), pull(sd_Temp_active_X3_19_20), pull(min_Temp_active_X3_19_20), 
    pull(max_Temp_active_X3_19_20), pull(mean_PAR_active_X3_19_20), pull(sd_PAR_active_X3_19_20),
    pull(max_PAR_active_X3_19_20), pull(max_Y_active_X3_19_20), 
    pull(mean_Y_active_X3_19_20), pull(sd_Y_active_X3_19_20),
    pull(mean_ETR_active_X3_19_20),pull(sd_ETR_active_X3_19_20),
    pull(max_ETR_active_X3_19_20), 0, 0, 0, 0, 0, 0
  ),
  Bryum_X1 = c(pull(total_active_hours_19_20_X1), pull(Percentage_active_hours_19_20_X1),
    pull(mean_Temp_X1_19_20), pull(sd_Temp_X1_19_20), pull(min_Temp_X1_19_20), pull(max_Temp_X1_19_20), 
    pull(mean_Temp_active_X1_19_20), pull(sd_Temp_active_X1_19_20), pull(min_Temp_active_X1_19_20), 
    pull(max_Temp_active_X1_19_20), pull(mean_PAR_active_X1_19_20), pull(sd_PAR_active_X1_19_20),
    pull(max_PAR_active_X1_19_20), pull(max_Y_active_X1_19_20), 
    pull(mean_Y_active_X1_19_20), pull(sd_Y_active_X1_19_20),
    pull(mean_ETR_active_X1_19_20),pull(sd_ETR_active_X1_19_20),
    pull(max_ETR_active_X1_19_20), 0, 0, 0, 0, 0, 0
  ),
  Bryum_X2 = c(
    pull(total_active_hours_19_20_X2), pull(Percentage_active_hours_19_20_X2),
   pull(mean_Temp_X2_19_20), pull(sd_Temp_X2_19_20), pull(min_Temp_X2_19_20), pull(max_Temp_X2_19_20), 
    pull(mean_Temp_active_X2_19_20), pull(sd_Temp_active_X2_19_20), pull(min_Temp_active_X2_19_20), 
    pull(max_Temp_active_X2_19_20), pull(mean_PAR_active_X2_19_20), pull(sd_PAR_active_X2_19_20),
    pull(max_PAR_active_X2_19_20), pull(max_Y_active_X2_19_20), 
    pull(mean_Y_active_X2_19_20), pull(sd_Y_active_X2_19_20),
    pull(mean_ETR_active_X2_19_20),pull(sd_ETR_active_X2_19_20),
    pull(max_ETR_active_X2_19_20), 0, 0, 0, 0, 0, 0
  ),
  Bryum_X4 = c(
    pull(total_active_hours_19_20_X4), pull(Percentage_active_hours_19_20_X4),
   pull(mean_Temp_X4_19_20), pull(sd_Temp_X4_19_20), pull(min_Temp_X4_19_20), pull(max_Temp_X4_19_20), 
    pull(mean_Temp_active_X4_19_20), pull(sd_Temp_active_X4_19_20), pull(min_Temp_active_X4_19_20), 
    pull(max_Temp_active_X4_19_20), pull(mean_PAR_active_X4_19_20), pull(sd_PAR_active_X4_19_20),
    pull(max_PAR_active_X4_19_20), pull(max_Y_active_X4_19_20), 
    pull(mean_Y_active_X4_19_20), pull(sd_Y_active_X4_19_20),
    pull(mean_ETR_active_X4_19_20),pull(sd_ETR_active_X4_19_20),
    pull(max_ETR_active_X4_19_20), 0, 0, 0, 0, 0, 0
  ),
  Bryum_average = c(
    ...
    pull(max_ETR_active_moss_19_20), 0, 0, 0, 0, 0, 0
  ))
...
write.xlsx(table_2019_2020, file = "stats/summers/table_2019_2020.xlsx") # save table
 ...
 table_2020_2021 <- data.frame(  
  ...
  Austroplaca_X3 = c(
    pull(total_active_hours_20_21_X3), pull(Percentage_active_hours_20_21_X3), # pull removes the value from the tibble
    pull(mean_Temp_X3_20_21), pull(sd_Temp_X3_20_21), pull(min_Temp_X3_20_21), pull(max_Temp_X3_20_21), 
    pull(mean_Temp_active_X3_20_21), pull(sd_Temp_active_X3_20_21), pull(min_Temp_active_X3_20_21), 
    pull(max_Temp_active_X3_20_21), pull(mean_PAR_active_X3_20_21), pull(sd_PAR_active_X3_20_21),
    pull(max_PAR_active_X3_20_21), pull(max_Y_active_X3_20_21), 
    pull(mean_Y_active_X3_20_21), pull(sd_Y_active_X3_20_21),
    pull(mean_ETR_active_X3_20_21),pull(sd_ETR_active_X3_20_21),
    pull(max_ETR_active_X3_20_21), 0, 0, 0, 0, 0, 0
  ),
  Bryum_X1 = c(pull(total_active_hours_20_21_X1), pull(Percentage_active_hours_20_21_X1),
    pull(mean_Temp_X1_20_21), pull(sd_Temp_X1_20_21), pull(min_Temp_X1_20_21), pull(max_Temp_X1_20_21), 
    pull(mean_Temp_active_X1_20_21), pull(sd_Temp_active_X1_20_21), pull(min_Temp_active_X1_20_21), 
    pull(max_Temp_active_X1_20_21), pull(mean_PAR_active_X1_20_21), pull(sd_PAR_active_X1_20_21),
    pull(max_PAR_active_X1_20_21), pull(max_Y_active_X1_20_21), 
    pull(mean_Y_active_X1_20_21), pull(sd_Y_active_X1_20_21),
    pull(mean_ETR_active_X1_20_21),pull(sd_ETR_active_X1_20_21),
    pull(max_ETR_active_X1_20_21), 0, 0, 0, 0, 0, 0
  ),
  Bryum_X2 = c(pull(total_active_hours_20_21_X2), pull(Percentage_active_hours_20_21_X2),
   pull(mean_Temp_X2_20_21), pull(sd_Temp_X2_20_21), pull(min_Temp_X2_20_21), pull(max_Temp_X2_20_21), 
    pull(mean_Temp_active_X2_20_21), pull(sd_Temp_active_X2_20_21), pull(min_Temp_active_X2_20_21), 
    pull(max_Temp_active_X2_20_21), pull(mean_PAR_active_X2_20_21), pull(sd_PAR_active_X2_20_21),
    pull(max_PAR_active_X2_20_21), pull(max_Y_active_X2_20_21), 
    pull(mean_Y_active_X2_20_21), pull(sd_Y_active_X2_20_21),
    pull(mean_ETR_active_X2_20_21),pull(sd_ETR_active_X2_20_21),
    pull(max_ETR_active_X2_20_21), 0, 0, 0, 0, 0, 0
  ),
  Bryum_X4 = c(
    pull(total_active_hours_20_21_X4), pull(Percentage_active_hours_20_21_X4),
    pull(mean_Temp_X4_20_21), pull(sd_Temp_X4_20_21), pull(min_Temp_X4_20_21), pull(max_Temp_X4_20_21), 
    pull(mean_Temp_active_X4_20_21), pull(sd_Temp_active_X4_20_21), pull(min_Temp_active_X4_20_21), 
    pull(max_Temp_active_X4_20_21), pull(mean_PAR_active_X4_20_21), pull(sd_PAR_active_X4_20_21),
    pull(max_PAR_active_X4_20_21), pull(max_Y_active_X4_20_21), 
    pull(mean_Y_active_X4_20_21), pull(sd_Y_active_X4_20_21),
    pull(mean_ETR_active_X4_20_21),pull(sd_ETR_active_X4_20_21),
    pull(max_ETR_active_X4_20_21), 0, 0, 0, 0, 0, 0
  ),
  Bryum_average = c(
    pull(total_active_hours_20_21_moss), pull(Percentage_active_hours_20_21_moss), 
    pull(mean_Temp_X4_20_21), "-", pull(min_Temp_moss_20_21), pull(max_Temp_moss_20_21), 
    pull(mean_Temp_active_moss_20_21), "-",pull(min_Temp_active_moss_20_21), 
    pull(max_Temp_active_moss_20_21), pull(mean_PAR_active_moss_20_21), "-",
    pull(max_PAR_active_moss_20_21), pull(max_Y_active_moss_20_21), 
    pull(mean_Y_active_moss_20_21), "-",pull(mean_ETR_active_moss_20_21), "-",
    pull(max_ETR_active_moss_20_21), 0, 0, 0, 0, 0, 0
  ))
...
table_2021_2022 <- data.frame(  
  ...
  Austroplaca_X3 = c(
    pull(total_active_hours_21_22_X3), pull(Percentage_active_hours_21_22_X3), # pull removes the value from the tibble
    pull(mean_Temp_X3_21_22), pull(sd_Temp_X3_21_22), pull(min_Temp_X3_21_22), pull(max_Temp_X3_21_22), 
    pull(mean_Temp_active_X3_21_22), pull(sd_Temp_active_X3_21_22), pull(min_Temp_active_X3_21_22), 
    pull(max_Temp_active_X3_21_22), pull(mean_PAR_active_X3_21_22), pull(sd_PAR_active_X3_21_22),
    pull(max_PAR_active_X3_21_22), pull(max_Y_active_X3_21_22), 
    pull(mean_Y_active_X3_21_22), pull(sd_Y_active_X3_21_22),
    pull(mean_ETR_active_X3_21_22),pull(sd_ETR_active_X3_21_22),
    pull(max_ETR_active_X3_21_22), 0, 0, 0, 0, 0, 0
  ),
  Bryum_X1 = c(pull(
    total_active_hours_21_22_X1), pull(Percentage_active_hours_21_22_X1),
    pull(mean_Temp_X1_21_22), pull(sd_Temp_X1_21_22), pull(min_Temp_X1_21_22), pull(max_Temp_X1_21_22), 
    pull(mean_Temp_active_X1_21_22), pull(sd_Temp_active_X1_21_22), pull(min_Temp_active_X1_21_22), 
    pull(max_Temp_active_X1_21_22), pull(mean_PAR_active_X1_21_22), pull(sd_PAR_active_X1_21_22),
    pull(max_PAR_active_X1_21_22), pull(max_Y_active_X1_21_22), 
    pull(mean_Y_active_X1_21_22), pull(sd_Y_active_X1_21_22),
    pull(mean_ETR_active_X1_21_22),pull(sd_ETR_active_X1_21_22),
    pull(max_ETR_active_X1_21_22), 0, 0, 0, 0, 0, 0
  ),
  Bryum_X2 = c(pull(
    total_active_hours_21_22_X2), pull(Percentage_active_hours_21_22_X2),
   pull(mean_Temp_X2_21_22), pull(sd_Temp_X2_21_22), pull(min_Temp_X2_21_22), pull(max_Temp_X2_21_22), 
    pull(mean_Temp_active_X2_21_22), pull(sd_Temp_active_X2_21_22), pull(min_Temp_active_X2_21_22), 
    pull(max_Temp_active_X2_21_22), pull(mean_PAR_active_X2_21_22), pull(sd_PAR_active_X2_21_22),
    pull(max_PAR_active_X2_21_22), pull(max_Y_active_X2_21_22), 
    pull(mean_Y_active_X2_21_22), pull(sd_Y_active_X2_21_22),
    pull(mean_ETR_active_X2_21_22),pull(sd_ETR_active_X2_21_22),
    pull(max_ETR_active_X2_21_22), 0, 0, 0, 0, 0, 0
  ),
  Bryum_X4 = c(
     pull(total_active_hours_21_22_X4), pull(Percentage_active_hours_21_22_X4),
   pull(mean_Temp_X4_21_22), pull(sd_Temp_X4_21_22), pull(min_Temp_X4_21_22), pull(max_Temp_X4_21_22), 
    pull(mean_Temp_active_X4_21_22), pull(sd_Temp_active_X4_21_22), pull(min_Temp_active_X4_21_22), 
    pull(max_Temp_active_X4_21_22), pull(mean_PAR_active_X4_21_22), pull(sd_PAR_active_X4_21_22),
    pull(max_PAR_active_X4_21_22), pull(max_Y_active_X4_21_22), 
    pull(mean_Y_active_X4_21_22), pull(sd_Y_active_X4_21_22),
    pull(mean_ETR_active_X4_21_22),pull(sd_ETR_active_X4_21_22),
    pull(max_ETR_active_X4_21_22), 0, 0, 0, 0, 0, 0
  ),
  Bryum_average = c(
    pull(total_active_hours_21_22_moss), pull(Percentage_active_hours_21_22_moss), 
    pull(mean_Temp_X4_21_22), "-", pull(min_Temp_moss_21_22), pull(max_Temp_moss_21_22), 
    pull(mean_Temp_active_moss_21_22), "-",pull(min_Temp_active_moss_21_22), 
    pull(max_Temp_active_moss_21_22), pull(mean_PAR_active_moss_21_22), "-",
    pull(max_PAR_active_moss_21_22), pull(max_Y_active_moss_21_22), 
    pull(mean_Y_active_moss_21_22), "-",pull(mean_ETR_active_moss_21_22), "-",
    pull(max_ETR_active_moss_21_22), 0, 0, 0, 0, 0, 0
  ))
...
table_2022_2023 <- data.frame(  
  ...
  Austroplaca_X3 = c(
    pull(total_active_hours_22_23_X3), pull(Percentage_active_hours_22_23_X3), # pull removes the value from the tibble
    pull(mean_Temp_X3_22_23), pull(sd_Temp_X3_22_23), pull(min_Temp_X3_22_23), pull(max_Temp_X3_22_23), 
    pull(mean_Temp_active_X3_22_23), pull(sd_Temp_active_X3_22_23), pull(min_Temp_active_X3_22_23), 
    pull(max_Temp_active_X3_22_23), pull(mean_PAR_active_X3_22_23), pull(sd_PAR_active_X3_22_23),
    pull(max_PAR_active_X3_22_23), pull(max_Y_active_X3_22_23), 
    pull(mean_Y_active_X3_22_23), pull(sd_Y_active_X3_22_23),
    pull(mean_ETR_active_X3_22_23),pull(sd_ETR_active_X3_22_23),
    pull(max_ETR_active_X3_22_23), 0, 0, 0, 0, 0, 0
  ),
  Bryum_X1 = c(
    pull(total_active_hours_22_23_X1), pull(Percentage_active_hours_22_23_X1),
    pull(mean_Temp_X1_22_23), pull(sd_Temp_X1_22_23), pull(min_Temp_X1_22_23), pull(max_Temp_X1_22_23), 
    pull(mean_Temp_active_X1_22_23), pull(sd_Temp_active_X1_22_23), pull(min_Temp_active_X1_22_23), 
    pull(max_Temp_active_X1_22_23), pull(mean_PAR_active_X1_22_23), pull(sd_PAR_active_X1_22_23),
    pull(max_PAR_active_X1_22_23), pull(max_Y_active_X1_22_23), 
    pull(mean_Y_active_X1_22_23), pull(sd_Y_active_X1_22_23),
    pull(mean_ETR_active_X1_22_23),pull(sd_ETR_active_X1_22_23),
    pull(max_ETR_active_X1_22_23), 0, 0, 0, 0, 0, 0
  ),
  Bryum_X2 = c(
    pull(total_active_hours_22_23_X2), pull(Percentage_active_hours_22_23_X2),
    pull(mean_Temp_X2_22_23), pull(sd_Temp_X2_22_23), pull(min_Temp_X2_22_23), pull(max_Temp_X2_22_23), 
    pull(mean_Temp_active_X2_22_23), pull(sd_Temp_active_X2_22_23), pull(min_Temp_active_X2_22_23), 
    pull(max_Temp_active_X2_22_23), pull(mean_PAR_active_X2_22_23), pull(sd_PAR_active_X2_22_23),
    pull(max_PAR_active_X2_22_23), pull(max_Y_active_X2_22_23), 
    pull(mean_Y_active_X2_22_23), pull(sd_Y_active_X2_22_23),
    pull(mean_ETR_active_X2_22_23),pull(sd_ETR_active_X2_22_23),
    pull(max_ETR_active_X2_22_23), 0, 0, 0, 0, 0, 0
  ),
  Bryum_X4 = c(
     pull(total_active_hours_22_23_X4), pull(Percentage_active_hours_22_23_X4),
   pull(mean_Temp_X4_22_23), pull(sd_Temp_X4_22_23), pull(min_Temp_X4_22_23), pull(max_Temp_X4_22_23), 
    pull(mean_Temp_active_X4_22_23), pull(sd_Temp_active_X4_22_23), pull(min_Temp_active_X4_22_23), 
    pull(max_Temp_active_X4_22_23), pull(mean_PAR_active_X4_22_23), pull(sd_PAR_active_X4_22_23),
    pull(max_PAR_active_X4_22_23), pull(max_Y_active_X4_22_23), 
    pull(mean_Y_active_X4_22_23), pull(sd_Y_active_X4_22_23),
    pull(mean_ETR_active_X4_22_23),pull(sd_ETR_active_X4_22_23),
    pull(max_ETR_active_X4_22_23), 0, 0, 0, 0, 0, 0
  ),
  Bryum_average = c(
    pull(total_active_hours_22_23_moss), pull(Percentage_active_hours_22_23_moss), 
    pull(mean_Temp_X4_22_23), "-", pull(min_Temp_moss_22_23), pull(max_Temp_moss_22_23), 
    pull(mean_Temp_active_moss_22_23), "-",pull(min_Temp_active_moss_22_23), 
    pull(max_Temp_active_moss_22_23), pull(mean_PAR_active_moss_22_23), "-",
    pull(max_PAR_active_moss_22_23), pull(max_Y_active_moss_22_23), 
    pull(mean_Y_active_moss_22_23), "-",pull(mean_ETR_active_moss_22_23), "-",
    pull(max_ETR_active_moss_22_23), 0, 0, 0, 0, 0, 0
  ))
...
## 10.3 Create a table per species

```{r}
# Austroplaca

table_austroplaca <- data.frame(
  Category = c(
 ...
 write.xlsx(table_austroplaca, file = "stats/austroplaca/table_austroplaca.xlsx") # save table 

 # Bryum X1
 
 table_bryum_x1 <- data.frame(
   Category = c(
    "Total active hours", "% active hours", "Average Thallus temp", "Min Thallus temp",
    "Max Thallus temp", "Average Thallus temp active", "Min Thallus temp active", 
    "Max Thallus temp active", "PAR", "Max Par", "MAX Yield", "Yield", "ETR", 
  ...
  write.xlsx(table_bryum_x1, file = "stats/bryum/table_bryum_x1.xlsx") # save table 
  
 # Bryum X2
 
 table_bryum_X2 <- data.frame(
   Category = c(
    "Total active hours", "% active hours", "Average Thallus temp", "Min Thallus temp",
    "Max Thallus temp", "Average Thallus temp active", "Min Thallus temp active", 
    "Max Thallus temp active", "PAR", "Max Par", "MAX Yield", "Yield", "ETR", 
  ...
  write.xlsx(table_bryum_X2, file = "stats/bryum/table_bryum_X2.xlsx") # save table  
  
# Bryum X4
 
 table_bryum_X4 <- data.frame(
   Category = c(
    "Total active hours", "% active hours", "Average Thallus temp", "Min Thallus temp",
    "Max Thallus temp", "Average Thallus temp active", "Min Thallus temp active", 
    "Max Thallus temp active", "PAR", "Max Par", "MAX Yield", "Yield", "ETR", 
  ...
  write.xlsx(table_bryum_X4, file = "stats/bryum/table_bryum_X4.xlsx") # save table 
  
# Bryum Average
 
 table_bryum_average <- data.frame(
   Category = c(
    "Total active hours", "% active hours", "Average Thallus temp", "Min Thallus temp",
    "Max Thallus temp", "Average Thallus temp active", "Min Thallus temp active", 
    "Max Thallus temp active", "PAR", "Max Par", "MAX Yield", "Yield", "ETR", 
  ...
  write.xlsx(table_bryum_average, file = "stats/bryum/table_bryum_average.xlsx") # save table 
```
