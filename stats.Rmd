...
(max_Temp_X3_19_20 <- mean_Temp_stats_X3_19_20 %>%  # extract the max Temp of the measuring period
    select(max_temp)) 
(mean_Temp_X3_19_20 <- mean_Temp_stats_X3_19_20 %>%  # extract the min Temp of the active period
    select(min_temp)) 
...
(maxx_Temp_active_X1_20_21 <- mean_Temp_active_stats_X1_20_21 %>%  # extract the mean Temp of the active period
  filter( X1.Active == TRUE) %>% 
  select( mean_temp))
...
(maxx_Temp_active_X1_21_22 <- mean_Temp_active_stats_X1_21_22 %>%  # extract the mean Temp of the active period
  filter( X1.Active == TRUE) %>% 
  select( mean_temp))
...
(maxx_Temp_active_X1_22_23 <- mean_Temp_active_stats_X1_22_23 %>%  # extract the mean Temp of the active period
  filter( X1.Active == TRUE) %>% 
  select( mean_temp))
...
(maxx_Temp_active_X2_20_21 <- mean_Temp_active_stats_X2_20_21 %>%  # extract the mean Temp of the active period
  filter( X2.Active == TRUE) %>% 
  select( mean_temp))
...
(maxx_Temp_active_X2_21_22 <- mean_Temp_active_stats_X2_21_22 %>%  # extract the mean Temp of the active period
  filter( X2.Active == TRUE) %>% 
  select( mean_temp))
...
(maxx_Temp_active_X2_22_23 <- mean_Temp_active_stats_X2_22_23 %>%  # extract the mean Temp of the active period
  filter( X2.Active == TRUE) %>% 
  select( mean_temp))
...
(maxx_Temp_active_X4_20_21 <- mean_Temp_active_stats_X4_20_21 %>%  # extract the mean Temp of the active period
  filter( X4.Active == TRUE) %>% 
  select( mean_temp))
...
(maxx_Temp_active_X4_21_22 <- mean_Temp_active_stats_X4_21_22 %>%  # extract the mean Temp of the active period
  filter( X4.Active == TRUE) %>% 
  select( mean_temp))
...
(maxx_Temp_active_moss_20_21 <- mean_Temp_moss_data_20_21 %>%  # extract the mean Temp of the active period
  filter( X1.Active == TRUE) %>% 
  select( mean_temp))
