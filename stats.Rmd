...
write.xlsx(table_2019_2020, file = "stats/general/table_general.xlsx") # save table
```
...
table_2019_2020 <- data.frame(  
  ...
  Bryum_X2 = c(
     pull(total_active_hours_X2), pull(Percentage_active_hours_X2), # pull removes thee value from the tibble
