...
(mean_yield_stats_X1_20_21 <- summer_20_21 %>% 
  group_by(X1.Active) %>% 
  summarise( n = n(),
    mean_Y = mean(X1.chosen_yield),
    max_Y = max(X1.chosen_yield),
    min_Y = min(X1.chosen_yield)))
...
(mean_ETR_stats_X1_20_21 <- summer_20_21 %>% 
  group_by(X1.Active) %>% 
  summarise( n = n(),
    mean_ETR = mean(X1.chosen_ETR),
    max_ETR = max(X1.chosen_ETR),
    min_ETR = min(X1.chosen_ETR)))
